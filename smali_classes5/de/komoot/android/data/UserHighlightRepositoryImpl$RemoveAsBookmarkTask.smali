.class final Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "pOriginal",
        "(Lde/komoot/android/data/UserHighlightRepositoryImpl;Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;)V",
...
.method public constructor <init>(Lde/komoot/android/data/UserHighlightRepositoryImpl;Landroid/content/Context;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)V
    ...
    .line 1
    iput-object p1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->b:Lde/komoot/android/data/UserHighlightRepositoryImpl;

    invoke-direct {p0, p2}, Lde/komoot/android/io/BaseStorageIOTask;-><init>(Landroid/content/Context;)V

    .line 2
    iput-object p3, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;

    return-void
.end method

.method private constructor <init>(Lde/komoot/android/data/UserHighlightRepositoryImpl;Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;)V
    .locals 0
    ...
    .line 4
    iget-object p1, p2, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    iput-object p1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
...
# virtual methods
.method public a0()Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;
    .locals 2

    new-instance v0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;

    iget-object v1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->b:Lde/komoot/android/data/UserHighlightRepositoryImpl;

    invoke-direct {v0, v1, p0}, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;-><init>(Lde/komoot/android/data/UserHighlightRepositoryImpl;Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;)V
...
.method public bridge synthetic deepCopy()Lde/komoot/android/io/ManagedStorageTask;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a0()Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;
...
.method public bridge synthetic execute(Landroid/content/Context;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->g0(Landroid/content/Context;)Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
...
.method protected g0(Landroid/content/Context;)Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    :try_start_0
    iget-object v0, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;

    invoke-static {p1, v0}, Lde/komoot/android/services/sync/DataFacade;->k(Landroid/content/Context;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)V
    :try_end_0
    .catch Lde/komoot/android/services/sync/SavedUserHighlightNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object p1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->b:Lde/komoot/android/data/UserHighlightRepositoryImpl;
    ...
    iget-object p1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    new-instance v0, Lde/komoot/android/ui/highlight/event/UserHighlightBookmarkRemoveEvent;

    iget-object v1, p0, Lde/komoot/android/data/UserHighlightRepositoryImpl$RemoveAsBookmarkTask;->a:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;

    invoke-direct {v0, v1}, Lde/komoot/android/ui/highlight/event/UserHighlightBookmarkRemoveEvent;-><init>(Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)V
