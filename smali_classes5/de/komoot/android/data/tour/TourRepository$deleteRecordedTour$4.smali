.class final Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/data/tour/TourRepository;->M(Lde/komoot/android/services/api/nativemodel/GenericMetaTour;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "de.komoot.android.data.tour.TourRepository$deleteRecordedTour$4"
    f = "TourRepository.kt"
    l = {
        0x589,
        0x591
...
# direct methods
.method constructor <init>(Lde/komoot/android/data/tour/TourRepository;Lde/komoot/android/services/api/nativemodel/GenericMetaTour;Lkotlin/coroutines/Continuation;)V
    .locals 0

    iput-object p1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->b:Lde/komoot/android/data/tour/TourRepository;

    iput-object p2, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->c:Lde/komoot/android/services/api/nativemodel/GenericMetaTour;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance p1, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;

    iget-object v0, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->b:Lde/komoot/android/data/tour/TourRepository;

    iget-object v1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->c:Lde/komoot/android/services/api/nativemodel/GenericMetaTour;

    invoke-direct {p1, v0, v1, p2}, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;-><init>(Lde/komoot/android/data/tour/TourRepository;Lde/komoot/android/services/api/nativemodel/GenericMetaTour;Lkotlin/coroutines/Continuation;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;

    sget-object p2, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->a:I
    ...
    iget-object p1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->b:Lde/komoot/android/data/tour/TourRepository;
    ...
    invoke-interface {p1, v1}, Lde/komoot/android/recording/ITourTrackerDB;->deleteTour(Lde/komoot/android/services/api/nativemodel/GenericMetaTour;)V
    ...
    iput v2, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->a:I
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->c:Lde/komoot/android/services/api/nativemodel/GenericMetaTour;
    ...
    iput v3, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->a:I
    ...
    new-instance v0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4$1;

    iget-object v1, p0, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4;->c:Lde/komoot/android/services/api/nativemodel/GenericMetaTour;

    invoke-direct {v0, v1}, Lde/komoot/android/data/tour/TourRepository$deleteRecordedTour$4$1;-><init>(Lde/komoot/android/services/api/nativemodel/GenericMetaTour;)V
