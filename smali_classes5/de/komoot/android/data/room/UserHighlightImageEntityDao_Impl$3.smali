.class Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl$3;
...
.method constructor <init>(Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `UserHighlightImageEntity` SET `id` = ?,`serverId` = ?,`highlightId` = ?,`filePath` = ?,`tourPhotoId` = ?,`clientHash` = ?,`analyticsSourceTool` = ?,`lastUploadAttempt` = ?,`uploadState` = ?,`uploadAction` = ?,`versionToDo` = ?,`versionDone` = ? WHERE `id` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl$3;->k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightImageEntity;)V

    return-void
.end method

.method public k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightImageEntity;)V
    .locals 4
    ...
    iget-object v0, p0, Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightImageEntityDao_Impl;
