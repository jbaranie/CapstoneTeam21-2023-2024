.class Lde/komoot/android/data/room/UserHighlightEntityDao_Impl$3;
...
.method constructor <init>(Lde/komoot/android/data/room/UserHighlightEntityDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lde/komoot/android/data/room/UserHighlightEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightEntityDao_Impl;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `UserHighlightEntity` SET `id` = ?,`serverId` = ?,`name` = ?,`sport` = ?,`creatorId` = ?,`startIndex` = ?,`endIndex` = ?,`geometry` = ?,`analyticsSourceTool` = ?,`createdAt` = ?,`changedAt` = ?,`tourId` = ?,`lastUploadAttempt` = ?,`uploadState` = ?,`uploadAction` = ?,`versionToDo` = ?,`versionDone` = ? WHERE `id` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/data/room/UserHighlightEntityDao_Impl$3;->k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightEntity;)V

    return-void
.end method

.method public k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightEntity;)V
    .locals 4
    ...
    iget-object v0, p0, Lde/komoot/android/data/room/UserHighlightEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightEntityDao_Impl;
