.class Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl$3;
...
.method constructor <init>(Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `UserHighlightTipEntity` SET `id` = ?,`serverId` = ?,`highlightId` = ?,`text` = ?,`createdAt` = ?,`changedAt` = ?,`analyticsSourceTool` = ?,`lastUploadAttempt` = ?,`uploadState` = ?,`uploadAction` = ?,`versionToDo` = ?,`versionDone` = ? WHERE `id` = ?"
...
.method public bridge synthetic i(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl$3;->k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightTipEntity;)V

    return-void
.end method

.method public k(Landroidx/sqlite/db/SupportSQLiteStatement;Lde/komoot/android/data/room/UserHighlightTipEntity;)V
    .locals 3
    ...
    iget-object v0, p0, Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl$3;->d:Lde/komoot/android/data/room/UserHighlightTipEntityDao_Impl;
