...
# direct methods
.method private d()Landroidx/recyclerview/widget/TileList$Tile;
    .locals 3
...
.method private e(Landroidx/recyclerview/widget/TileList$Tile;)V
    .locals 3
    ...
    invoke-interface {v0, v1, p1}, Landroidx/recyclerview/widget/ThreadUtil$MainThreadCallback;->b(ILandroidx/recyclerview/widget/TileList$Tile;)V
...
.method private f(I)V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->i(I)V
    ...
    :cond_2
    invoke-direct {p0, v2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->i(I)V
...
.method public a(IIIII)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->g(I)I

    move-result p1

    invoke-direct {p0, p2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->g(I)I

    move-result p2

    invoke-direct {p0, p3}, Landroidx/recyclerview/widget/AsyncListUtil$2;->g(I)I

    move-result p3

    iput p3, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->e:I

    invoke-direct {p0, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->g(I)I
    ...
    invoke-direct {p0, p1, p2, p5, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->j(IIIZ)V
    ...
    invoke-direct {p0, p2, p1, p5, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->j(IIIZ)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1, p3, p5, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->j(IIIZ)V
    ...
    invoke-direct {p0, p2, p1, p5, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->j(IIIZ)V
...
.method public b(II)V
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->h(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->d()Landroidx/recyclerview/widget/TileList$Tile;
    ...
    invoke-direct {p0, p2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->f(I)V

    invoke-direct {p0, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->e(Landroidx/recyclerview/widget/TileList$Tile;)V
