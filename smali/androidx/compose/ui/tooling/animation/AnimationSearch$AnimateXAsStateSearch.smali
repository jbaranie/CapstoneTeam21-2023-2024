...
.method private final e(Landroidx/compose/ui/tooling/data/CallGroup;)Landroidx/compose/animation/core/Animatable;
    .locals 6
    ...
    :goto_1
    instance-of v2, v4, Landroidx/compose/animation/core/Animatable;
    ...
    invoke-static {v2, v4}, Landroidx/compose/ui/tooling/PreviewUtilsKt;->e(Landroidx/compose/ui/tooling/data/Group;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/tooling/data/Group;
...
.method private final f(Landroidx/compose/ui/tooling/data/CallGroup;)Landroidx/compose/animation/core/AnimationSpec;
    .locals 4
    ...
    invoke-static {p1, v2}, Lkotlin/collections/CollectionsKt;->C(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method private final g(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearch;->e(Landroidx/compose/ui/tooling/data/CallGroup;)Landroidx/compose/animation/core/Animatable;

    move-result-object v2

    invoke-direct {p0, v1}, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearch;->f(Landroidx/compose/ui/tooling/data/CallGroup;)Landroidx/compose/animation/core/AnimationSpec;
    ...
    invoke-static {v6, v8}, Landroidx/compose/ui/tooling/PreviewUtilsKt;->e(Landroidx/compose/ui/tooling/data/Group;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/tooling/data/Group;
    ...
    :cond_10
    invoke-static {v4, v1}, Lkotlin/collections/CollectionsKt;->Q0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    const-string v4, "null cannot be cast to non-null type androidx.compose.ui.tooling.animation.ToolingState<T of androidx.compose.ui.tooling.animation.AnimationSearch.AnimateXAsStateSearch.findAnimations$lambda$1>"
...
.method public a(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1}, Landroidx/compose/ui/tooling/animation/AnimationSearch$AnimateXAsStateSearch;->g(Ljava/util/Collection;)Ljava/util/List;
