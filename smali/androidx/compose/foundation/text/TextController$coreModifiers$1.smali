...
.method constructor <init>(Landroidx/compose/foundation/text/TextController;)V
    ...
    iput-object p1, p0, Landroidx/compose/foundation/text/TextController$coreModifiers$1;->b:Landroidx/compose/foundation/text/TextController;
...
.method public final a(Landroidx/compose/ui/layout/LayoutCoordinates;)V
    ...
    iget-object v0, p0, Landroidx/compose/foundation/text/TextController$coreModifiers$1;->b:Landroidx/compose/foundation/text/TextController;

    invoke-virtual {v0}, Landroidx/compose/foundation/text/TextController;->k()Landroidx/compose/foundation/text/TextState;

    move-result-object v0

    invoke-virtual {v0, p1}, Landroidx/compose/foundation/text/TextState;->l(Landroidx/compose/ui/layout/LayoutCoordinates;)V
    ...
    iget-object v1, p0, Landroidx/compose/foundation/text/TextController$coreModifiers$1;->b:Landroidx/compose/foundation/text/TextController;
    ...
    iget-object p1, p0, Landroidx/compose/foundation/text/TextController$coreModifiers$1;->b:Landroidx/compose/foundation/text/TextController;

    invoke-virtual {p1}, Landroidx/compose/foundation/text/TextController;->k()Landroidx/compose/foundation/text/TextState;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/compose/foundation/text/TextState;->f()J
    ...
    iget-object v2, p0, Landroidx/compose/foundation/text/TextController$coreModifiers$1;->b:Landroidx/compose/foundation/text/TextController;

    invoke-virtual {v2}, Landroidx/compose/foundation/text/TextController;->k()Landroidx/compose/foundation/text/TextState;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/compose/foundation/text/TextState;->h()J

    move-result-wide v2

    invoke-interface {p1, v2, v3}, Landroidx/compose/foundation/text/selection/SelectionRegistrar;->d(J)V
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/compose/foundation/text/TextState;->p(J)V
