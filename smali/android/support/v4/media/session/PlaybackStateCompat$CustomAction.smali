...
.method public static b(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->l(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->f(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;

    move-result-object v3

    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->m(Landroid/media/session/PlaybackState$CustomAction;)I
