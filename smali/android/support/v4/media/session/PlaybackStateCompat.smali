...
.method public static b(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->j(Landroid/media/session/PlaybackState;)Ljava/util/List;
    ...
    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api22Impl;->a(Landroid/media/session/PlaybackState;)Landroid/os/Bundle;
    ...
    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->r(Landroid/media/session/PlaybackState;)I

    move-result v5

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->q(Landroid/media/session/PlaybackState;)J

    move-result-wide v6

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->i(Landroid/media/session/PlaybackState;)J

    move-result-wide v8

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->p(Landroid/media/session/PlaybackState;)F

    move-result v10

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->g(Landroid/media/session/PlaybackState;)J

    move-result-wide v11

    const/4 v13, 0x0

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->k(Landroid/media/session/PlaybackState;)Ljava/lang/CharSequence;

    move-result-object v14

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->n(Landroid/media/session/PlaybackState;)J

    move-result-wide v15

    invoke-static {v1}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->h(Landroid/media/session/PlaybackState;)J
