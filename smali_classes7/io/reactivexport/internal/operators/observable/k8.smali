.class public final Lio/reactivexport/internal/operators/observable/k8;
...
.method protected Q(Lio/reactivexport/Observer;)V
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivexport/internal/operators/observable/k8;->c:Lio/reactivexport/functions/n;
    ...
    new-instance v2, Lio/reactivexport/internal/operators/observable/j8;

    iget-object v3, p0, Lio/reactivexport/internal/operators/observable/a;->b:Lio/reactivexport/r;

    invoke-direct {v2, p1, v0, v3}, Lio/reactivexport/internal/operators/observable/j8;-><init>(Lio/reactivexport/Observer;Lio/reactivexport/subjects/d;Lio/reactivexport/r;)V

    invoke-interface {p1, v2}, Lio/reactivexport/Observer;->o(Lio/reactivexport/disposables/Disposable;)V

    iget-object p1, v2, Lio/reactivexport/internal/operators/observable/j8;->e:Lio/reactivexport/internal/operators/observable/j8$a;

    invoke-interface {v1, p1}, Lio/reactivexport/r;->b(Lio/reactivexport/Observer;)V

    invoke-virtual {v2}, Lio/reactivexport/internal/operators/observable/j8;->d()V
