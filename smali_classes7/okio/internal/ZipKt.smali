...
.method private static final a(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {v0, v3, v4, v1, v2}, Lokio/Path$Companion;->e(Lokio/Path$Companion;Ljava/lang/String;ZILjava/lang/Object;)Lokio/Path;
    ...
    invoke-virtual {v2}, Lokio/internal/ZipEntry;->a()Lokio/Path;
    ...
    invoke-virtual {v3}, Lokio/Path;->l()Lokio/Path;
    ...
    invoke-virtual {v4}, Lokio/internal/ZipEntry;->b()Ljava/util/List;
...
.method public static final d(Lokio/Path;Lokio/FileSystem;Lkotlin/jvm/functions/Function1;)Lokio/ZipFileSystem;
    .locals 18
    ...
    invoke-virtual {v1, v0}, Lokio/FileSystem;->o(Lokio/Path;)Lokio/FileHandle;
    ...
    :goto_0
    invoke-virtual {v3, v4, v5}, Lokio/FileHandle;->t(J)Lokio/Source;

    move-result-object v10

    invoke-static {v10}, Lokio/Okio;->d(Lokio/Source;)Lokio/BufferedSource;
    ...
    :try_start_1
    invoke-interface {v10}, Lokio/BufferedSource;->a5()I
    ...
    invoke-static {v10}, Lokio/internal/ZipKt;->f(Lokio/BufferedSource;)Lokio/internal/EocdRecord;

    move-result-object v8

    invoke-virtual {v8}, Lokio/internal/EocdRecord;->b()I

    move-result v9

    int-to-long v11, v9

    invoke-interface {v10, v11, v12}, Lokio/BufferedSource;->h3(J)Ljava/lang/String;
    ...
    :try_start_3
    invoke-interface {v4}, Lokio/BufferedSource;->a5()I
    ...
    invoke-interface {v4}, Lokio/BufferedSource;->G2()J
    ...
    invoke-virtual {v3, v12, v13}, Lokio/FileHandle;->t(J)Lokio/Source;

    move-result-object v5

    invoke-static {v5}, Lokio/Okio;->d(Lokio/Source;)Lokio/BufferedSource;
    ...
    :try_start_4
    invoke-interface {v5}, Lokio/BufferedSource;->a5()I
    ...
    invoke-static {v5, v8}, Lokio/internal/ZipKt;->j(Lokio/BufferedSource;Lokio/internal/EocdRecord;)Lokio/internal/EocdRecord;
    ...
    invoke-virtual {v8}, Lokio/internal/EocdRecord;->a()J
    ...
    :try_start_c
    invoke-virtual {v8}, Lokio/internal/EocdRecord;->c()J
    ...
    invoke-static {v5}, Lokio/internal/ZipKt;->e(Lokio/BufferedSource;)Lokio/internal/ZipEntry;

    move-result-object v10

    invoke-virtual {v10}, Lokio/internal/ZipEntry;->f()J
...
.method public static final e(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    .locals 27
    ...
    invoke-interface/range {p0 .. p0}, Lokio/BufferedSource;->a5()I
    ...
    invoke-interface/range {p0 .. p0}, Lokio/BufferedSource;->B2()S
    ...
    iput-wide v1, v6, Lkotlin/jvm/internal/Ref$LongRef;->a:J

    int-to-long v0, v0

    invoke-interface {v8, v0, v1}, Lokio/BufferedSource;->h3(J)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v3, v1, v0}, Lkotlin/text/StringsKt;->Q(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    :goto_0
    iget-wide v5, v11, Lkotlin/jvm/internal/Ref$LongRef;->a:J
    ...
    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->g(Lokio/BufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-static {v0, v1, v3, v2, v12}, Lokio/Path$Companion;->e(Lokio/Path$Companion;Ljava/lang/String;ZILjava/lang/Object;)Lokio/Path;

    move-result-object v0

    move-object/from16 v2, v25

    invoke-virtual {v0, v2}, Lokio/Path;->n(Ljava/lang/String;)Lokio/Path;

    move-result-object v0

    const/4 v4, 0x2

    invoke-static {v2, v1, v3, v4, v12}, Lkotlin/text/StringsKt;->u(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    iget-wide v10, v14, Lkotlin/jvm/internal/Ref$LongRef;->a:J

    move-object/from16 v2, v26

    iget-wide v14, v2, Lkotlin/jvm/internal/Ref$LongRef;->a:J
...
.method private static final f(Lokio/BufferedSource;)Lokio/internal/EocdRecord;
    .locals 10

    invoke-interface {p0}, Lokio/BufferedSource;->B2()S
    ...
    invoke-interface {p0}, Lokio/BufferedSource;->a5()I
...
.method private static final g(Lokio/BufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-interface {p0, v4, v5}, Lokio/BufferedSource;->U2(J)V

    invoke-interface {p0}, Lokio/BufferedSource;->s()Lokio/Buffer;
...
.method public static final h(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    .locals 1
    ...
    invoke-static {p0, p1}, Lokio/internal/ZipKt;->i(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
...
.method private static final i(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    .locals 17
    ...
    invoke-virtual/range {p1 .. p1}, Lokio/FileMetadata;->c()Ljava/lang/Long;
    ...
    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->g(Lokio/BufferedSource;ILkotlin/jvm/functions/Function2;)V

    new-instance v0, Lokio/FileMetadata;

    invoke-virtual/range {p1 .. p1}, Lokio/FileMetadata;->g()Z

    move-result v7

    invoke-virtual/range {p1 .. p1}, Lokio/FileMetadata;->f()Z

    move-result v8

    const/4 v9, 0x0

    invoke-virtual/range {p1 .. p1}, Lokio/FileMetadata;->d()Ljava/lang/Long;
...
.method private static final j(Lokio/BufferedSource;Lokio/internal/EocdRecord;)Lokio/internal/EocdRecord;
    .locals 8
    ...
    invoke-interface {p0}, Lokio/BufferedSource;->G2()J
    ...
    invoke-virtual {p1}, Lokio/internal/EocdRecord;->b()I
...
.method public static final k(Lokio/BufferedSource;)V
    ...
    invoke-static {p0, v0}, Lokio/internal/ZipKt;->i(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
