...
.method private final a(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    :goto_3
    invoke-virtual {v3, v11}, Lokio/ByteString;->k(I)B

    move-result v5

    invoke-virtual {v4, v11}, Lokio/ByteString;->k(I)B
    ...
    invoke-virtual {v1, v11}, Lokio/ByteString;->k(I)B
    ...
    invoke-virtual {v2, v11}, Lokio/ByteString;->k(I)B
    ...
    invoke-virtual {v0, v11}, Lokio/ByteString;->k(I)B
    ...
    invoke-virtual {v10, v15}, Lokio/Buffer;->X1(Lokio/Source;)J
    ...
    invoke-virtual {v3, v7}, Lokio/ByteString;->k(I)B

    move-result v1

    invoke-virtual {v4, v7}, Lokio/ByteString;->k(I)B
    ...
    invoke-virtual {v10, v11}, Lokio/Buffer;->X1(Lokio/Source;)J
...
.method public final varargs d([Lokio/ByteString;)Lokio/Options;
    ...
    :cond_1
    invoke-static/range {p1 .. p1}, Lkotlin/collections/ArraysKt;->h1([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    invoke-static {v1}, Lkotlin/collections/CollectionsKt;->A(Ljava/util/List;)V
    ...
    invoke-virtual {v9, v6}, Lokio/ByteString;->Q(Lokio/ByteString;)Z
