...
.method public c(Lokio/Path;Lokio/Path;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Lokio/Path;->t()Ljava/nio/file/Path;

    move-result-object p1

    invoke-virtual {p2}, Lokio/Path;->t()Ljava/nio/file/Path;
...
.method public n(Lokio/Path;)Lokio/FileMetadata;
    ...
    invoke-virtual/range {p1 .. p1}, Lokio/Path;->t()Ljava/nio/file/Path;
    ...
    invoke-static {v6, v1, v7, v4, v2}, Lokio/Path$Companion;->f(Lokio/Path$Companion;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokio/Path;
    ...
    invoke-direct {v0, v1}, Lokio/NioSystemFileSystem;->v(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
