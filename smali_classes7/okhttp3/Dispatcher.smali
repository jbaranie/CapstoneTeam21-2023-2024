...
.method private final f(Ljava/util/Deque;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lokhttp3/Dispatcher;->i()Ljava/lang/Runnable;
    ...
    invoke-direct {p0}, Lokhttp3/Dispatcher;->l()Z
...
.method private final l()Z
    ...
    invoke-virtual {p0}, Lokhttp3/Dispatcher;->j()I
...
.method public final declared-synchronized d()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {v1, v8}, Lkotlin/jvm/internal/Intrinsics;->r(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    const/4 v8, 0x0

    invoke-static {v1, v8}, Lokhttp3/internal/Util;->N(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
