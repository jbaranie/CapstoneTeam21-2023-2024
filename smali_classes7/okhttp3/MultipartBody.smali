...
.method public constructor <init>(Lokio/ByteString;Lokhttp3/MediaType;Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Lokhttp3/MultipartBody;->h()Ljava/lang/String;
...
.method private final i(Lokio/BufferedSink;Z)J
    ...
    iget-object v7, p0, Lokhttp3/MultipartBody;->c:Ljava/util/List;
    ...
    invoke-virtual {v5}, Lokhttp3/MultipartBody$Part;->b()Lokhttp3/Headers;

    move-result-object v7

    invoke-virtual {v5}, Lokhttp3/MultipartBody$Part;->a()Lokhttp3/RequestBody;
    ...
    invoke-interface {p1, v8}, Lokio/BufferedSink;->o5(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v11}, Lokio/BufferedSink;->D1(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->f:[B
    ...
    invoke-interface {v11, v9}, Lokio/BufferedSink;->D1(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v8}, Lokio/BufferedSink;->D1(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v8, v7}, Lokio/BufferedSink;->D1(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v9}, Lokio/BufferedSink;->D1(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lokio/BufferedSink;->Y2(J)Lokio/BufferedSink;
    ...
    :cond_5
    invoke-virtual {v5, p1}, Lokhttp3/RequestBody;->g(Lokio/BufferedSink;)V
...
.method public a()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->i(Lokio/BufferedSink;Z)J
...
.method public g(Lokio/BufferedSink;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->i(Lokio/BufferedSink;Z)J
