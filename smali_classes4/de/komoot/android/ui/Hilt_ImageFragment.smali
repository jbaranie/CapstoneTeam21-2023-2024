.class public abstract Lde/komoot/android/ui/Hilt_ImageFragment;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->j:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->k:Z
...
.method private c3()V
    ...
    iget-object v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->g:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->g:Landroid/content/ContextWrapper;
    ...
    iput-boolean v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->h:Z
...
.method public final X2()Ldagger/hilt/android/internal/managers/FragmentComponentManager;
    ...
    iget-object v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->i:Ldagger/hilt/android/internal/managers/FragmentComponentManager;

    if-nez v0, :cond_1

    iget-object v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->i:Ldagger/hilt/android/internal/managers/FragmentComponentManager;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lde/komoot/android/ui/Hilt_ImageFragment;->a3()Ldagger/hilt/android/internal/managers/FragmentComponentManager;

    move-result-object v1

    iput-object v1, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->i:Ldagger/hilt/android/internal/managers/FragmentComponentManager;
...
.method protected e3()V
    ...
    iget-boolean v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->k:Z
    ...
    invoke-virtual {p0}, Lde/komoot/android/ui/Hilt_ImageFragment;->generatedComponent()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lde/komoot/android/ui/ImageFragment_GeneratedInjector;

    invoke-static {p0}, Ldagger/hilt/internal/UnsafeCasts;->a(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lde/komoot/android/ui/ImageFragment;

    invoke-interface {v0, v1}, Lde/komoot/android/ui/ImageFragment_GeneratedInjector;->R(Lde/komoot/android/ui/ImageFragment;)V
...
.method public final generatedComponent()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lde/komoot/android/ui/Hilt_ImageFragment;->X2()Ldagger/hilt/android/internal/managers/FragmentComponentManager;
...
.method public getContext()Landroid/content/Context;
    ...
    iget-boolean v0, p0, Lde/komoot/android/ui/Hilt_ImageFragment;->h:Z
    ...
    :cond_0
    invoke-direct {p0}, Lde/komoot/android/ui/Hilt_ImageFragment;->c3()V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 7
    invoke-virtual {p0}, Lde/komoot/android/ui/Hilt_ImageFragment;->e3()V
