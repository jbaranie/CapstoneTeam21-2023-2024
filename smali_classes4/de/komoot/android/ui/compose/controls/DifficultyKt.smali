.class public final Lde/komoot/android/ui/compose/controls/DifficultyKt;
...
.method public static final a(Ljava/lang/String;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v5, "de.komoot.android.ui.compose.controls.DifficultyLabel (Difficulty.kt:17)"

    invoke-static {v2, v1, v3, v5}, Landroidx/compose/runtime/ComposerKt;->Z(IIILjava/lang/String;)V

    :cond_4
    sget-object v2, Lde/komoot/android/ui/resources/RouteDifficultyRelation;->INSTANCE:Lde/komoot/android/ui/resources/RouteDifficultyRelation;

    invoke-virtual {v2, v0}, Lde/komoot/android/ui/resources/RouteDifficultyRelation;->a(Ljava/lang/String;)I

    move-result v3

    const/4 v5, 0x0

    invoke-static {v3, v15, v5}, Landroidx/compose/ui/res/ColorResources_androidKt;->a(ILandroidx/compose/runtime/Composer;I)J
    ...
    invoke-static {v8, v6, v7, v3}, Landroidx/compose/foundation/BackgroundKt;->c(Landroidx/compose/ui/Modifier;JLandroidx/compose/ui/graphics/Shape;)Landroidx/compose/ui/Modifier;
    ...
    invoke-static {v6, v5, v15, v5}, Landroidx/compose/foundation/layout/BoxKt;->h(Landroidx/compose/ui/Alignment;ZLandroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-virtual {v2, v0}, Lde/komoot/android/ui/resources/RouteDifficultyRelation;->d(Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v15, v5}, Landroidx/compose/material/MaterialTheme;->c(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material/Typography;

    move-result-object v6

    invoke-virtual {v6}, Landroidx/compose/material/Typography;->d()Landroidx/compose/ui/text/TextStyle;
    ...
    invoke-virtual {v6}, Landroidx/compose/ui/text/font/FontWeight$Companion;->a()Landroidx/compose/ui/text/font/FontWeight;
    ...
    invoke-virtual {v2, v15, v5}, Landroidx/compose/material/MaterialTheme;->a(Landroidx/compose/runtime/Composer;I)Landroidx/compose/material/Colors;
    ...
    invoke-static {v8, v4, v2}, Landroidx/compose/foundation/layout/PaddingKt;->j(Landroidx/compose/ui/Modifier;FF)Landroidx/compose/ui/Modifier;
    ...
    :cond_8
    new-instance v3, Lde/komoot/android/ui/compose/controls/DifficultyKt$DifficultyLabel$2;

    invoke-direct {v3, v0, v1}, Lde/komoot/android/ui/compose/controls/DifficultyKt$DifficultyLabel$2;-><init>(Ljava/lang/String;I)V
