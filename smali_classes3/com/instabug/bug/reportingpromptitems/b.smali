.class public Lcom/instabug/bug/reportingpromptitems/b;
...
.method public g(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    sget v2, Lcom/instabug/library/R$drawable;->ibg_core_ic_question:I
    ...
    invoke-virtual {p0, p1}, Lcom/instabug/bug/reportingpromptitems/b;->j(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/instabug/library/core/plugin/PluginPromptOption;->u(Ljava/lang/String;)V

    invoke-virtual {p0, p1}, Lcom/instabug/bug/reportingpromptitems/b;->i(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/instabug/library/core/plugin/PluginPromptOption;->k(Ljava/lang/String;)V

    new-instance v1, Lcom/instabug/bug/reportingpromptitems/a;

    invoke-direct {v1, p0, p1}, Lcom/instabug/bug/reportingpromptitems/a;-><init>(Lcom/instabug/bug/reportingpromptitems/b;Landroid/content/Context;)V
...
.method protected varargs h(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/instabug/bug/reportingpromptitems/b;->k(Landroid/content/Context;)V
...
.method k(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/instabug/bug/h;->a(Landroid/content/Context;)Landroid/content/Intent;
