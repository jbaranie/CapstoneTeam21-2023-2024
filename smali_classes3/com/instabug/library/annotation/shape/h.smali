.class public Lcom/instabug/library/annotation/shape/h;
...
.method public e(Landroid/graphics/Canvas;Lcom/instabug/library/annotation/d;[Lcom/instabug/library/annotation/a;)V
    ...
    iget-object v0, p0, Lcom/instabug/library/annotation/shape/h;->e:Landroid/graphics/PointF;

    if-nez v0, :cond_0

    invoke-virtual {p2}, Lcom/instabug/library/annotation/d;->e()Landroid/graphics/PointF;
    ...
    invoke-virtual {v1, v0}, Lcom/instabug/library/annotation/a;->e(Landroid/graphics/PointF;)V
    ...
    invoke-virtual {v0, v1}, Lcom/instabug/library/annotation/a;->b(I)V

    aget-object p2, p3, p2

    invoke-virtual {p2, p1}, Lcom/instabug/library/annotation/a;->c(Landroid/graphics/Canvas;)V
...
.method public i(Landroid/graphics/PointF;Lcom/instabug/library/annotation/d;)Z
    ...
    iget v2, p0, Lcom/instabug/library/annotation/shape/h;->f:F

    iget v3, p0, Lcom/instabug/library/annotation/shape/h;->g:F

    iget v4, p0, Lcom/instabug/library/annotation/shape/h;->h:F
...
.method public k(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;FF)V
    ...
    iput v0, p0, Lcom/instabug/library/annotation/shape/h;->h:F
    ...
    iput v0, p0, Lcom/instabug/library/annotation/shape/h;->f:F
    ...
    iput v0, p0, Lcom/instabug/library/annotation/shape/h;->g:F

    iget v0, p0, Lcom/instabug/library/annotation/shape/h;->h:F
    ...
    invoke-static {v0, v2, v1}, Lcom/instabug/library/annotation/utility/c;->f(FFLandroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v0

    iput-object v0, p0, Lcom/instabug/library/annotation/shape/h;->e:Landroid/graphics/PointF;

    const/16 v0, 0xc8

    invoke-static {p2, v0}, Lcom/instabug/library/annotation/utility/b;->b(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object p2

    invoke-static {p2}, Lcom/instabug/library/annotation/utility/b;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
