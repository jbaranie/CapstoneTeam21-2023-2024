...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/instabug/library/annotation/ColorPickerPopUpView$d;
    }
.end annotation
...
.field private b:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;

.field private c:I

.field private d:Lcom/instabug/library/annotation/ColorPickerPopUpView$c;

.field private final e:Lcom/instabug/library/annotation/ColorPickerPopUpView$b;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->i:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    new-instance p1, Lcom/instabug/library/annotation/ColorPickerPopUpView$b;

    invoke-direct {p1, p0}, Lcom/instabug/library/annotation/ColorPickerPopUpView$b;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->e:Lcom/instabug/library/annotation/ColorPickerPopUpView$b;
    ...
    iput-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->f:[I

    .line 6
    invoke-direct {p0, p2, p3}, Lcom/instabug/library/annotation/ColorPickerPopUpView;->d(Landroid/util/AttributeSet;I)V
...
.method private b(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->h:Ljava/util/List;
    ...
    invoke-direct {p0, p1, v1}, Lcom/instabug/library/annotation/ColorPickerPopUpView;->c(Landroid/graphics/Canvas;Lcom/instabug/library/annotation/ColorPickerPopUpView$a;)V
...
.method private c(Landroid/graphics/Canvas;Lcom/instabug/library/annotation/ColorPickerPopUpView$a;)V
    .locals 10
...
.method private d(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->e:Lcom/instabug/library/annotation/ColorPickerPopUpView$b;
    ...
    invoke-direct {p0}, Lcom/instabug/library/annotation/ColorPickerPopUpView;->getScreenOrientation()Lcom/instabug/library/annotation/ColorPickerPopUpView$d;

    move-result-object p2

    sget-object v0, Lcom/instabug/library/annotation/ColorPickerPopUpView$d;->PORTRAIT:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;
    ...
    :cond_0
    sget-object v0, Lcom/instabug/library/annotation/ColorPickerPopUpView$d;->LANDSCAPE:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;

    :goto_0
    iput-object v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->b:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    sget p1, Lcom/instabug/library/annotation/ColorPickerPopUpView;->i:I
    ...
    iput-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->h:Ljava/util/List;

    iget-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->f:[I
    ...
    iget-object v3, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->h:Ljava/util/List;
...
.method private getScreenOrientation()Lcom/instabug/library/annotation/ColorPickerPopUpView$d;
    .locals 2
...
.method private setSelectedColor(I)V
    ...
    iget-object v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->f:[I

    aget v0, v0, p1

    iput v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->g:I
    ...
    :goto_0
    iget-object v2, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->h:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->d:Lcom/instabug/library/annotation/ColorPickerPopUpView$c;

    if-eqz v0, :cond_2

    iget v1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->g:I

    invoke-interface {v0, v1, p1}, Lcom/instabug/library/annotation/ColorPickerPopUpView$c;->a(II)V
...
.method public getCheckCircleColorList()Ljava/util/List;
    .locals 1
...
.method public getSelectedColor()I
    ...
    iget v0, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->g:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1}, Lcom/instabug/library/annotation/ColorPickerPopUpView;->b(Landroid/graphics/Canvas;)V
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object p2, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->b:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;

    sget-object p3, Lcom/instabug/library/annotation/ColorPickerPopUpView$d;->LANDSCAPE:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;
    ...
    invoke-static {p3}, Lcom/instabug/library/internal/device/InstabugDeviceProperties;->k(Landroid/content/Context;)Z
    ...
    :goto_0
    iget-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->h:Ljava/util/List;
...
.method public setOnColorSelectionListener(Lcom/instabug/library/annotation/ColorPickerPopUpView$c;)V
    .locals 0
    .param p1    # Lcom/instabug/library/annotation/ColorPickerPopUpView$c;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param

    iput-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->d:Lcom/instabug/library/annotation/ColorPickerPopUpView$c;

    return-void
.end method

.method public setOrientation(Lcom/instabug/library/annotation/ColorPickerPopUpView$d;)V
    .locals 0

    iput-object p1, p0, Lcom/instabug/library/annotation/ColorPickerPopUpView;->b:Lcom/instabug/library/annotation/ColorPickerPopUpView$d;
