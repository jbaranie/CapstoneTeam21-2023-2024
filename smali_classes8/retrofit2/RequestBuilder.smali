...
.method constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    invoke-virtual {p4}, Lokhttp3/Headers;->i()Lokhttp3/Headers$Builder;
...
.method private static i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v3, p0, v2, v0, p1}, Lretrofit2/RequestBuilder;->j(Lokio/Buffer;Ljava/lang/String;IIZ)V
...
.method private static j(Lokio/Buffer;Ljava/lang/String;IIZ)V
    ...
    invoke-virtual {p0, v3}, Lokio/Buffer;->X(I)Lokio/Buffer;
    ...
    invoke-virtual {p0, v5}, Lokio/Buffer;->X(I)Lokio/Buffer;

    and-int/lit8 v2, v2, 0xf

    aget-char v2, v4, v2

    invoke-virtual {p0, v2}, Lokio/Buffer;->X(I)Lokio/Buffer;
...
.method h(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Lokhttp3/Request$Builder;->v(Ljava/lang/Class;Ljava/lang/Object;)Lokhttp3/Request$Builder;
...
.method k()Lokhttp3/Request$Builder;
    ...
    invoke-virtual {v0, v2}, Lokhttp3/Request$Builder;->k(Lokhttp3/Headers;)Lokhttp3/Request$Builder;

    move-result-object v0

    iget-object v2, p0, Lretrofit2/RequestBuilder;->a:Ljava/lang/String;

    invoke-virtual {v0, v2, v1}, Lokhttp3/Request$Builder;->l(Ljava/lang/String;Lokhttp3/RequestBody;)Lokhttp3/Request$Builder;
