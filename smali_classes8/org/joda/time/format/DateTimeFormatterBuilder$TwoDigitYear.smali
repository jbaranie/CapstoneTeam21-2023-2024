...
.method private b(JLorg/joda/time/Chronology;)I
    .locals 1
    ...
    invoke-virtual {p3, p1, p2}, Lorg/joda/time/DateTimeField;->c(J)I
...
.method private c(Lorg/joda/time/ReadablePartial;)I
    .locals 1
...
.method public f(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
    ...
    iget-boolean v1, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->c:Z
    ...
    iget p2, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->b:I

    invoke-virtual {p1}, Lorg/joda/time/format/DateTimeParserBucket;->o()Ljava/lang/Integer;
    ...
    iget-object p2, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->a:Lorg/joda/time/DateTimeFieldType;

    invoke-virtual {p1, p2, v1}, Lorg/joda/time/format/DateTimeParserBucket;->s(Lorg/joda/time/DateTimeFieldType;I)V
    ...
    :goto_a
    iget-object p3, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->a:Lorg/joda/time/DateTimeFieldType;

    invoke-virtual {p1, p3, p2}, Lorg/joda/time/format/DateTimeParserBucket;->s(Lorg/joda/time/DateTimeFieldType;I)V
...
.method public i(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;Ljava/util/Locale;)V
    ...
    invoke-direct {p0, p2}, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->c(Lorg/joda/time/ReadablePartial;)I
    ...
    invoke-static {p1, p2, p3}, Lorg/joda/time/format/FormatUtils;->a(Ljava/lang/Appendable;II)V
...
.method public k(Ljava/lang/Appendable;JLorg/joda/time/Chronology;ILorg/joda/time/DateTimeZone;Ljava/util/Locale;)V
    ...
    invoke-direct {p0, p2, p3, p4}, Lorg/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear;->b(JLorg/joda/time/Chronology;)I
