...
.field private static final m0:Lorg/joda/time/chrono/CopticChronology;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/joda/time/chrono/CopticChronology;->k0:Lorg/joda/time/DateTimeField;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lorg/joda/time/chrono/CopticChronology;->l0:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, Lorg/joda/time/DateTimeZone;->UTC:Lorg/joda/time/DateTimeZone;

    invoke-static {v0}, Lorg/joda/time/chrono/CopticChronology;->S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/CopticChronology;

    move-result-object v0

    sput-object v0, Lorg/joda/time/chrono/CopticChronology;->m0:Lorg/joda/time/chrono/CopticChronology;
...
.method public static S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/CopticChronology;
    .locals 1

    const/4 v0, 0x4

    invoke-static {p0, v0}, Lorg/joda/time/chrono/CopticChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/CopticChronology;
...
.method public static T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/CopticChronology;
    .locals 13
    ...
    :cond_0
    sget-object v0, Lorg/joda/time/chrono/CopticChronology;->l0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    invoke-static {v2, p1}, Lorg/joda/time/chrono/CopticChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/CopticChronology;
...
.method private readResolve()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/joda/time/chrono/CopticChronology;->B0()I
    ...
    invoke-static {v0, v1}, Lorg/joda/time/chrono/CopticChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/CopticChronology;
...
.method public O()Lorg/joda/time/Chronology;
    ...
    sget-object v0, Lorg/joda/time/chrono/CopticChronology;->m0:Lorg/joda/time/chrono/CopticChronology;
...
.method public P(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/Chronology;
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/joda/time/chrono/CopticChronology;->q()Lorg/joda/time/DateTimeZone;
    ...
    :cond_1
    invoke-static {p1}, Lorg/joda/time/chrono/CopticChronology;->S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/CopticChronology;
...
.method protected U(Lorg/joda/time/chrono/AssembledChronology$Fields;)V
    ...
    sget-object v0, Lorg/joda/time/chrono/CopticChronology;->k0:Lorg/joda/time/DateTimeField;
