...
# static fields
.field private static final o0:Lorg/joda/time/chrono/JulianChronology;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/joda/time/chrono/JulianChronology;->p0:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, Lorg/joda/time/DateTimeZone;->UTC:Lorg/joda/time/DateTimeZone;

    invoke-static {v0}, Lorg/joda/time/chrono/JulianChronology;->T0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/JulianChronology;

    move-result-object v0

    sput-object v0, Lorg/joda/time/chrono/JulianChronology;->o0:Lorg/joda/time/chrono/JulianChronology;
...
.method public static T0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/JulianChronology;
    .locals 1

    const/4 v0, 0x4

    invoke-static {p0, v0}, Lorg/joda/time/chrono/JulianChronology;->U0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/JulianChronology;
...
.method public static U0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/JulianChronology;
    .locals 5
    ...
    :cond_0
    sget-object v0, Lorg/joda/time/chrono/JulianChronology;->p0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    invoke-static {v2, p1}, Lorg/joda/time/chrono/JulianChronology;->U0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/JulianChronology;
...
.method private readResolve()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/joda/time/chrono/JulianChronology;->B0()I
    ...
    invoke-static {v0, v1}, Lorg/joda/time/chrono/JulianChronology;->U0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/JulianChronology;
...
.method public O()Lorg/joda/time/Chronology;
    ...
    sget-object v0, Lorg/joda/time/chrono/JulianChronology;->o0:Lorg/joda/time/chrono/JulianChronology;
...
.method public P(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/Chronology;
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/joda/time/chrono/JulianChronology;->q()Lorg/joda/time/DateTimeZone;
    ...
    :cond_1
    invoke-static {p1}, Lorg/joda/time/chrono/JulianChronology;->T0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/JulianChronology;
...
.method a0(I)J
    ...
    invoke-virtual {p0, p1}, Lorg/joda/time/chrono/JulianChronology;->Q0(I)Z
...
.method f0(III)J
    ...
    invoke-static {p1}, Lorg/joda/time/chrono/JulianChronology;->S0(I)I

    move-result p1

    invoke-super {p0, p1, p2, p3}, Lorg/joda/time/chrono/BasicChronology;->f0(III)J
