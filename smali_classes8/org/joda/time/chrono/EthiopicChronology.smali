...
.field private static final k0:Lorg/joda/time/DateTimeField;

.field private static final l0:Ljava/util/concurrent/ConcurrentHashMap;

.field private static final m0:Lorg/joda/time/chrono/EthiopicChronology;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/joda/time/chrono/EthiopicChronology;->k0:Lorg/joda/time/DateTimeField;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lorg/joda/time/chrono/EthiopicChronology;->l0:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, Lorg/joda/time/DateTimeZone;->UTC:Lorg/joda/time/DateTimeZone;

    invoke-static {v0}, Lorg/joda/time/chrono/EthiopicChronology;->S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/EthiopicChronology;

    move-result-object v0

    sput-object v0, Lorg/joda/time/chrono/EthiopicChronology;->m0:Lorg/joda/time/chrono/EthiopicChronology;
...
.method public static S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/EthiopicChronology;
    .locals 1

    const/4 v0, 0x4

    invoke-static {p0, v0}, Lorg/joda/time/chrono/EthiopicChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/EthiopicChronology;
...
.method public static T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/EthiopicChronology;
    .locals 13
    ...
    :cond_0
    sget-object v0, Lorg/joda/time/chrono/EthiopicChronology;->l0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, v2, v3}, Lorg/joda/time/chrono/LimitChronology;->b0(Lorg/joda/time/Chronology;Lorg/joda/time/ReadableDateTime;Lorg/joda/time/ReadableDateTime;)Lorg/joda/time/chrono/LimitChronology;
    ...
    :cond_2
    invoke-static {v2, p1}, Lorg/joda/time/chrono/EthiopicChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/EthiopicChronology;
...
.method private readResolve()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/joda/time/chrono/EthiopicChronology;->B0()I

    move-result v1

    invoke-static {v0, v1}, Lorg/joda/time/chrono/EthiopicChronology;->T0(Lorg/joda/time/DateTimeZone;I)Lorg/joda/time/chrono/EthiopicChronology;
...
.method public O()Lorg/joda/time/Chronology;
    ...
    sget-object v0, Lorg/joda/time/chrono/EthiopicChronology;->m0:Lorg/joda/time/chrono/EthiopicChronology;
...
.method public P(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/Chronology;
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/joda/time/chrono/EthiopicChronology;->q()Lorg/joda/time/DateTimeZone;
    ...
    :cond_1
    invoke-static {p1}, Lorg/joda/time/chrono/EthiopicChronology;->S0(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/chrono/EthiopicChronology;
...
.method protected U(Lorg/joda/time/chrono/AssembledChronology$Fields;)V
    ...
    sget-object v0, Lorg/joda/time/chrono/EthiopicChronology;->k0:Lorg/joda/time/DateTimeField;
