...
.field private final transient f:[Lorg/joda/time/tz/CachedDateTimeZone$Info;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lorg/joda/time/tz/CachedDateTimeZone;->g:I
...
.method private constructor <init>(Lorg/joda/time/DateTimeZone;)V
    ...
    sget v0, Lorg/joda/time/tz/CachedDateTimeZone;->g:I

    add-int/lit8 v0, v0, 0x1

    new-array v0, v0, [Lorg/joda/time/tz/CachedDateTimeZone$Info;

    iput-object v0, p0, Lorg/joda/time/tz/CachedDateTimeZone;->f:[Lorg/joda/time/tz/CachedDateTimeZone$Info;

    iput-object p1, p0, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;

    return-void
.end method

.method private E(J)Lorg/joda/time/tz/CachedDateTimeZone$Info;
    .locals 6
    ...
    iget-object v1, p0, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;
    ...
    :goto_0
    iget-object v4, p0, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;

    invoke-virtual {v4, p1, p2}, Lorg/joda/time/DateTimeZone;->z(J)J
    ...
    iget-object p2, p0, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;

    invoke-direct {p1, p2, v4, v5}, Lorg/joda/time/tz/CachedDateTimeZone$Info;-><init>(Lorg/joda/time/DateTimeZone;J)V

    iput-object p1, v3, Lorg/joda/time/tz/CachedDateTimeZone$Info;->c:Lorg/joda/time/tz/CachedDateTimeZone$Info;
...
.method public static F(Lorg/joda/time/DateTimeZone;)Lorg/joda/time/tz/CachedDateTimeZone;
    .locals 1
...
.method private G(J)Lorg/joda/time/tz/CachedDateTimeZone$Info;
    ...
    iget-object v2, p0, Lorg/joda/time/tz/CachedDateTimeZone;->f:[Lorg/joda/time/tz/CachedDateTimeZone$Info;

    sget v3, Lorg/joda/time/tz/CachedDateTimeZone;->g:I
    ...
    iget-wide v5, v4, Lorg/joda/time/tz/CachedDateTimeZone$Info;->a:J
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lorg/joda/time/tz/CachedDateTimeZone;->E(J)Lorg/joda/time/tz/CachedDateTimeZone$Info;
...
.method public B(J)J
    ...
    iget-object v0, p0, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lorg/joda/time/tz/CachedDateTimeZone;->e:Lorg/joda/time/DateTimeZone;
...
.method public x()Z
    ...
    invoke-virtual {v0}, Lorg/joda/time/DateTimeZone;->x()Z
...
.method public z(J)J
    ...
    invoke-virtual {v0, p1, p2}, Lorg/joda/time/DateTimeZone;->z(J)J
