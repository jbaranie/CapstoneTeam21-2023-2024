Instructions below. This tool converts dex classes into jar files which can then be turned into readable code by using JDGUI. I am providing the tool instead of the output code because the codebase was enormous.  
