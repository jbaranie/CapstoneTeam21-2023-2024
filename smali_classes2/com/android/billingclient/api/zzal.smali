...
.method synthetic constructor <init>(Ljava/lang/ref/WeakReference;Landroid/os/ResultReceiver;Lcom/android/billingclient/api/zzak;)V
    ...
    iput-object p1, p0, Lcom/android/billingclient/api/zzal;->a:Ljava/lang/ref/WeakReference;

    iput-object p2, p0, Lcom/android/billingclient/api/zzal;->b:Landroid/os/ResultReceiver;
...
.method public final f4(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/zzal;->b:Landroid/os/ResultReceiver;
    ...
    invoke-static {v1, p1}, Lcom/google/android/gms/internal/play_billing/zzb;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/billingclient/api/zzal;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object v6, p0, Lcom/android/billingclient/api/zzal;->b:Landroid/os/ResultReceiver;
    ...
    invoke-static {v1, v0, p1}, Lcom/google/android/gms/internal/play_billing/zzb;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_3
    :goto_0
    iget-object p1, p0, Lcom/android/billingclient/api/zzal;->b:Landroid/os/ResultReceiver;
