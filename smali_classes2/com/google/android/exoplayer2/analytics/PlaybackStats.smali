...
.method public static varargs a([Lcom/google/android/exoplayer2/analytics/PlaybackStats;)Lcom/google/android/exoplayer2/analytics/PlaybackStats;
    ...
    iget v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->a:I
    ...
    iget-object v6, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->N:[J
    ...
    iget-wide v12, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->d:J
    ...
    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->d:J
    ...
    :cond_2
    :goto_2
    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->e:I

    add-int/2addr v14, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->f:I

    add-int/2addr v15, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->g:I

    add-int v16, v16, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->h:I
    ...
    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->i:J
    ...
    :cond_4
    :goto_3
    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->j:I

    add-int v20, v20, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->k:I

    add-int v21, v21, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->l:I

    add-int v22, v22, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->m:I

    add-int v25, v25, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->n:I
    ...
    iget-wide v10, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->o:J

    goto :goto_4

    :cond_5
    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->o:J
    ...
    :cond_6
    :goto_4
    iget v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->p:I

    add-int v27, v27, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->s:J

    add-long v28, v28, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->t:J

    add-long v30, v30, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->u:J

    add-long v32, v32, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->v:J

    add-long v34, v34, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->w:J

    add-long v36, v36, v5

    iget-wide v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->x:J

    add-long v38, v38, v5

    iget v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->y:I

    add-int v40, v40, v5

    iget v5, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->z:I
    ...
    iget v8, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->A:I

    goto :goto_5

    :cond_7
    iget v6, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->A:I
    ...
    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->B:J
    ...
    :cond_a
    :goto_6
    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->C:I
    ...
    :cond_c
    :goto_7
    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->E:J

    add-long v47, v47, v1

    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->F:J

    add-long v49, v49, v1

    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->G:J

    add-long v51, v51, v1

    iget-wide v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->H:J

    add-long v53, v53, v1

    iget v1, v9, Lcom/google/android/exoplayer2/analytics/PlaybackStats;->I:I
