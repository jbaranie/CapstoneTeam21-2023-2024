...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/util/Util;->A([B)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->I(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
...
.method private static E(Ljava/lang/String;Lcom/google/android/exoplayer2/text/ssa/SsaStyle;Lcom/google/android/exoplayer2/text/ssa/SsaStyle$Overrides;FF)Lcom/google/android/exoplayer2/text/Cue;
    .locals 8
    ...
    invoke-virtual {p0, v3, v7}, Lcom/google/android/exoplayer2/text/Cue$Builder;->q(FI)Lcom/google/android/exoplayer2/text/Cue$Builder;
    ...
    :goto_1
    invoke-static {v0}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->O(I)Landroid/text/Layout$Alignment;
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->N(I)I
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->M(I)I
    ...
    invoke-static {p1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->D(I)F
...
.method private F(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Ljava/nio/charset/Charset;
    .locals 0

    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->P()Ljava/nio/charset/Charset;
...
.method private G(Ljava/lang/String;Lcom/google/android/exoplayer2/text/ssa/SsaDialogueFormat;Ljava/util/List;Ljava/util/List;)V
    .locals 10
    ...
    invoke-static {v1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->L(Ljava/lang/String;)J
    ...
    :cond_1
    iget v6, p2, Lcom/google/android/exoplayer2/text/ssa/SsaDialogueFormat;->b:I

    aget-object v6, v0, v6

    invoke-static {v6}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->L(Ljava/lang/String;)J
    ...
    invoke-static {p2, p1, v0, v3, v4}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->E(Ljava/lang/String;Lcom/google/android/exoplayer2/text/ssa/SsaStyle;Lcom/google/android/exoplayer2/text/ssa/SsaStyle$Overrides;FF)Lcom/google/android/exoplayer2/text/Cue;

    move-result-object p1

    invoke-static {v1, v2, p4, p3}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->C(JLjava/util/List;Ljava/util/List;)I

    move-result p2

    invoke-static {v8, v9, p4, p3}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->C(JLjava/util/List;Ljava/util/List;)I
...
.method private H(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/util/List;Ljava/util/List;Ljava/nio/charset/Charset;)V
    .locals 4
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1, p4}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :cond_3
    invoke-direct {p0, v1, v0, p2, p3}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->G(Ljava/lang/String;Lcom/google/android/exoplayer2/text/ssa/SsaDialogueFormat;Ljava/util/List;Ljava/util/List;)V
...
.method private I(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
    .locals 2

    :cond_0
    :goto_0
    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->J(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->K(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)Ljava/util/Map;
...
.method private J(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
    .locals 4
    ...
    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->h(Ljava/nio/charset/Charset;)C
...
.method private static K(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)Ljava/util/Map;
    .locals 5
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->h(Ljava/nio/charset/Charset;)C
...
.method protected A([BIZ)Lcom/google/android/exoplayer2/text/Subtitle;
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->F(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Ljava/nio/charset/Charset;

    move-result-object p1

    iget-boolean p2, p0, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->o:Z

    if-nez p2, :cond_0

    invoke-direct {p0, v1, p1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->I(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/nio/charset/Charset;)V

    :cond_0
    invoke-direct {p0, v1, p3, v0, p1}, Lcom/google/android/exoplayer2/text/ssa/SsaDecoder;->H(Lcom/google/android/exoplayer2/util/ParsableByteArray;Ljava/util/List;Ljava/util/List;Ljava/nio/charset/Charset;)V
