...
.method public constructor <init>(Ljava/lang/String;IJ)V
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->M()V
...
.method private G(ZBB)Z
    ...
    invoke-static {p2}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->F(B)Z
...
.method private L(BB)V
    ...
    invoke-static {p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->K(B)Z
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->H(B)Z
...
.method private P()Z
    ...
    iget-wide v4, p0, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->x:J
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/text/cea/CeaDecoder;->k()J
    ...
    iget-wide v4, p0, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->k:J
...
.method private Q(B)Z
    ...
    invoke-static {p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->A(B)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->r(B)I
...
.method private s()Ljava/util/List;
    ...
    invoke-virtual {v5, v2}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder$CueBuilder;->g(I)Lcom/google/android/exoplayer2/text/Cue;
...
.method private static v(BB)C
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->u(B)C
...
.method private y(B)V
    ...
    :pswitch_0
    invoke-direct {p0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->s()Ljava/util/List;
    ...
    :pswitch_4
    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->N(I)V

    const/4 p1, 0x4

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->O(I)V
    ...
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->O(I)V
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->O(I)V
...
.method public bridge synthetic b()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->i()Lcom/google/android/exoplayer2/text/SubtitleOutputBuffer;
...
.method protected f(Lcom/google/android/exoplayer2/text/SubtitleInputBuffer;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->S([BI)V
    ...
    invoke-direct {p0, v1, v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->G(ZBB)Z
    ...
    :cond_8
    invoke-direct {p0, v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->L(BB)V
    ...
    :cond_9
    invoke-direct {p0, v5}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->Q(B)Z
    ...
    :cond_a
    invoke-static {v5}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->A(B)Z
    ...
    invoke-static {v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->w(B)C
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder$CueBuilder;->f()V

    iget-object v0, p0, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->m:Lcom/google/android/exoplayer2/text/cea/Cea608Decoder$CueBuilder;

    invoke-static {v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->v(BB)C
    ...
    :cond_d
    invoke-static {v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->E(BB)Z

    move-result v0

    if-eqz v0, :cond_e

    invoke-direct {p0, v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->z(BB)V

    goto :goto_3

    :cond_e
    invoke-static {v5, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->J(BB)Z
    ...
    invoke-static {v0, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder$CueBuilder;->a(Lcom/google/android/exoplayer2/text/cea/Cea608Decoder$CueBuilder;I)I
    ...
    invoke-direct {p0, v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->y(B)V
    ...
    invoke-static {v5}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->q(B)C
    ...
    invoke-static {v6}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->q(B)C
...
.method public i()Lcom/google/android/exoplayer2/text/SubtitleOutputBuffer;
    ...
    invoke-super {p0}, Lcom/google/android/exoplayer2/text/cea/CeaDecoder;->i()Lcom/google/android/exoplayer2/text/SubtitleOutputBuffer;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/exoplayer2/text/cea/Cea608Decoder;->P()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lcom/google/android/exoplayer2/text/cea/CeaDecoder;->j()Lcom/google/android/exoplayer2/text/SubtitleOutputBuffer;
...
.method public bridge synthetic m(Lcom/google/android/exoplayer2/text/SubtitleInputBuffer;)V
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/exoplayer2/text/cea/CeaDecoder;->m(Lcom/google/android/exoplayer2/text/SubtitleInputBuffer;)V
