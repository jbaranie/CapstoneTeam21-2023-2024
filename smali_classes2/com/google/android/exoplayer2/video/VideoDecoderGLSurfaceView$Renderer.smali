...
.field private h:Lcom/google/android/exoplayer2/util/GlProgram;

.field private i:I

.field private j:Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;
...
.method private b()V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->h:Lcom/google/android/exoplayer2/util/GlProgram;

    sget-object v3, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->n:[Ljava/lang/String;

    aget-object v3, v3, v1

    invoke-virtual {v0, v3}, Lcom/google/android/exoplayer2/util/GlProgram;->j(Ljava/lang/String;)I
    ...
    invoke-static {v3, v0}, Lcom/google/android/exoplayer2/util/GlUtil;->b(II)V
...
.method public onDrawFrame(Ljavax/microedition/khronos/opengles/GL10;)V
    ...
    iget-object v0, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->j:Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;
    ...
    :cond_1
    iput-object v0, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->j:Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;

    :cond_2
    iget-object v0, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->j:Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;
    ...
    iget v3, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->i:I
    ...
    :goto_0
    iget v3, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->i:I

    const/4 v6, 0x0

    invoke-static {v3, v5, v6, v2, v6}, Landroid/opengl/GLES20;->glUniformMatrix3fv(IIZ[FI)V

    iget-object v2, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->h:[I
    ...
    iget-object v3, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->g:[Ljava/nio/ByteBuffer;
    ...
    iget v8, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->f:I

    goto :goto_2

    :cond_5
    iget v9, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->f:I
    ...
    iget-object v8, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->b:[I
    ...
    iget v0, v0, Lcom/google/android/exoplayer2/decoder/VideoDecoderOutputBuffer;->e:I
    ...
    iget-object v10, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->d:[I
    ...
    iget-object v10, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->e:[I
    ...
    iget-object v11, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->g:[Ljava/nio/FloatBuffer;
    ...
    invoke-static {v12}, Lcom/google/android/exoplayer2/util/GlUtil;->g([F)Ljava/nio/FloatBuffer;

    move-result-object v7

    aput-object v7, v11, v0

    iget-object v7, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->c:[I
    ...
    iget-object v7, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->g:[Ljava/nio/FloatBuffer;

    aget-object v14, v7, v0

    invoke-static/range {v9 .. v14}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget-object v7, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->d:[I

    aget v9, v3, v0

    aput v9, v7, v0

    iget-object v7, v1, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->e:[I
...
.method public onSurfaceCreated(Ljavax/microedition/khronos/opengles/GL10;Ljavax/microedition/khronos/egl/EGLConfig;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->h:Lcom/google/android/exoplayer2/util/GlProgram;

    const-string p2, "in_pos"

    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/util/GlProgram;->e(Ljava/lang/String;)I
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->h:Lcom/google/android/exoplayer2/util/GlProgram;

    const-string v0, "in_tc_y"

    invoke-virtual {p2, v0}, Lcom/google/android/exoplayer2/util/GlProgram;->e(Ljava/lang/String;)I
    ...
    iget-object p1, p0, Lcom/google/android/exoplayer2/video/VideoDecoderGLSurfaceView$Renderer;->h:Lcom/google/android/exoplayer2/util/GlProgram;

    const-string p2, "mColorConversion"

    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/util/GlProgram;->j(Ljava/lang/String;)I
