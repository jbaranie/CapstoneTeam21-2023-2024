...
.method static G(Ljava/util/Collection;Ljava/lang/Object;)Z
    ...
    invoke-static {p1}, Lcom/google/common/collect/Maps;->U(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
...
.method private static H(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    .locals 1
...
.method private static J(Ljava/util/SortedSet;)Ljava/util/SortedSet;
    .locals 1
...
.method public static O(Ljava/util/Map;Lcom/google/common/collect/Maps$EntryTransformer;)Ljava/util/Map;
    .locals 1
...
.method public static P(Ljava/util/NavigableMap;Lcom/google/common/collect/Maps$EntryTransformer;)Ljava/util/NavigableMap;
    .locals 1
...
.method public static Q(Ljava/util/SortedMap;Lcom/google/common/collect/Maps$EntryTransformer;)Ljava/util/SortedMap;
    .locals 1
...
.method static R(Lcom/google/common/collect/Maps$EntryTransformer;Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
    .locals 1
...
.method public static S(Ljava/util/Map;Lcom/google/common/base/Function;)Ljava/util/Map;
    .locals 0
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/Maps;->O(Ljava/util/Map;Lcom/google/common/collect/Maps$EntryTransformer;)Ljava/util/Map;
...
.method public static T(Ljava/util/SortedMap;Lcom/google/common/base/Function;)Ljava/util/SortedMap;
    .locals 0
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/Maps;->Q(Ljava/util/SortedMap;Lcom/google/common/collect/Maps$EntryTransformer;)Ljava/util/SortedMap;
...
.method static U(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
    .locals 1
...
.method static V(Ljava/util/Iterator;)Lcom/google/common/collect/UnmodifiableIterator;
    .locals 1
...
.method static W(Ljava/util/Set;)Ljava/util/Set;
    .locals 1
...
.method public static X(Ljava/util/NavigableMap;)Ljava/util/NavigableMap;
    .locals 1
...
.method private static Y(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
    .locals 0
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/common/collect/Maps;->U(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
...
.method static Z()Lcom/google/common/base/Function;
    .locals 1
...
.method static synthetic a(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcom/google/common/collect/Maps;->I(Ljava/util/Set;)Ljava/util/Set;
...
.method static a0(Ljava/util/Iterator;)Ljava/util/Iterator;
    .locals 1
...
.method static synthetic b(Ljava/util/SortedSet;)Ljava/util/SortedSet;
    ...
    invoke-static {p0}, Lcom/google/common/collect/Maps;->J(Ljava/util/SortedSet;)Ljava/util/SortedSet;
...
.method static b0(Ljava/util/Map$Entry;)Ljava/lang/Object;
    .locals 0
...
.method static synthetic c(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    ...
    invoke-static {p0}, Lcom/google/common/collect/Maps;->H(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
...
.method static c0(Lcom/google/common/base/Predicate;)Lcom/google/common/base/Predicate;
    .locals 1
...
.method static synthetic d(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
    ...
    invoke-static {p0}, Lcom/google/common/collect/Maps;->Y(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
...
.method static o(Ljava/util/Map;Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lcom/google/common/collect/Maps;->a0(Ljava/util/Iterator;)Ljava/util/Iterator;

    move-result-object p0

    invoke-static {p0, p1}, Lcom/google/common/collect/Iterators;->j(Ljava/util/Iterator;Ljava/lang/Object;)Z
...
.method static p(Ljava/util/Map;Ljava/lang/Object;)Z
    .locals 1
...
.method public static q(Ljava/util/NavigableMap;Lcom/google/common/base/Predicate;)Ljava/util/NavigableMap;
    .locals 1
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/Maps;->s(Lcom/google/common/collect/Maps$FilteredEntryNavigableMap;Lcom/google/common/base/Predicate;)Ljava/util/NavigableMap;
...
.method private static r(Lcom/google/common/collect/Maps$AbstractFilteredMap;Lcom/google/common/base/Predicate;)Ljava/util/Map;
    .locals 2
...
.method private static s(Lcom/google/common/collect/Maps$FilteredEntryNavigableMap;Lcom/google/common/base/Predicate;)Ljava/util/NavigableMap;
    .locals 1
...
.method public static t(Ljava/util/Map;Lcom/google/common/base/Predicate;)Ljava/util/Map;
    .locals 2
    ...
    invoke-static {p0, v0}, Lcom/google/common/collect/Maps;->r(Lcom/google/common/collect/Maps$AbstractFilteredMap;Lcom/google/common/base/Predicate;)Ljava/util/Map;
...
.method static v(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableMap;
    .locals 4
