...
.method private final B1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)I
    .locals 3

    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->k()Z
    ...
    :cond_1
    invoke-virtual {p3, p1, p2, v1, p0}, Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;->i(JLkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;Lkotlinx/coroutines/EventLoopImplBase;)I
...
.method private final I1(Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;)Z
    .locals 1
...
.method public static final synthetic k1(Lkotlinx/coroutines/EventLoopImplBase;)Z
    .locals 0
...
.method private final u1(Ljava/lang/Runnable;)Z
    .locals 6
    ...
    invoke-virtual {v4}, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->i()Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
...
.method private final w1()V
    ...
    :cond_1
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/EventLoopImplPlatform;->g1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V
...
# virtual methods
.method protected final E1(JLjava/lang/Runnable;)Lkotlinx/coroutines/DisposableHandle;
    .locals 3
    ...
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/EventLoopImplBase;->y1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V
...
.method protected S0()J
    ...
    invoke-super {p0}, Lkotlinx/coroutines/EventLoop;->S0()J
...
.method public Y0()J
    ...
    invoke-direct {p0, v5}, Lkotlinx/coroutines/EventLoopImplBase;->u1(Ljava/lang/Runnable;)Z
    ...
    :cond_6
    :goto_3
    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->m1()Ljava/lang/Runnable;
    ...
    :cond_7
    invoke-virtual {p0}, Lkotlinx/coroutines/EventLoopImplBase;->S0()J
...
.method public o1(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, p1}, Lkotlinx/coroutines/EventLoopImplBase;->u1(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lkotlinx/coroutines/EventLoopImplPlatform;->h1()V
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/DefaultExecutor;->o1(Ljava/lang/Runnable;)V
...
.method public final r0(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lkotlinx/coroutines/EventLoopImplBase;->o1(Ljava/lang/Runnable;)V
...
.method public shutdown()V
    ...
    invoke-direct {p0, v0}, Lkotlinx/coroutines/EventLoopImplBase;->H1(Z)V

    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->l1()V

    :cond_0
    invoke-virtual {p0}, Lkotlinx/coroutines/EventLoopImplBase;->Y0()J
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/EventLoopImplBase;->w1()V
...
.method protected v1()Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/EventLoop;->W0()Z
...
.method public final y1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V
    .locals 2

    invoke-direct {p0, p1, p2, p3}, Lkotlinx/coroutines/EventLoopImplBase;->B1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)I
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/EventLoopImplPlatform;->g1(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p3}, Lkotlinx/coroutines/EventLoopImplBase;->I1(Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;)Z
