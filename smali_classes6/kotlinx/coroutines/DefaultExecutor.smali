...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v3, v1, v2}, Lkotlinx/coroutines/EventLoop;->U0(Lkotlinx/coroutines/EventLoop;ZILjava/lang/Object;)V
...
.method private final declared-synchronized M1()V
    ...
    :try_start_0
    invoke-direct {p0}, Lkotlinx/coroutines/DefaultExecutor;->U1()Z
...
.method public O(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Lkotlinx/coroutines/DisposableHandle;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/EventLoopImplBase;->E1(JLjava/lang/Runnable;)Lkotlinx/coroutines/DisposableHandle;
...
.method protected f1()Ljava/lang/Thread;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/DefaultExecutor;->N1()Ljava/lang/Thread;
...
.method public o1(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/DefaultExecutor;->R1()Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lkotlinx/coroutines/EventLoopImplBase;->o1(Ljava/lang/Runnable;)V
...
.method public run()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/DefaultExecutor;->M1()V
    ...
    :cond_1
    invoke-virtual {p0}, Lkotlinx/coroutines/EventLoopImplBase;->v1()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0}, Lkotlinx/coroutines/DefaultExecutor;->f1()Ljava/lang/Thread;
    ...
    :cond_9
    :try_start_2
    invoke-static {v5, v6, v10, v11}, Lkotlin/ranges/RangesKt;->j(JJ)J
