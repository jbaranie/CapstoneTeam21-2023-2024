.class public final Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;",
        "Lcom/apollographql/apollo3/api/Adapter;",
        "Lde/komoot/android/test/BookTripMutation$BookTrips;",
...
# static fields
.field public static final INSTANCE:Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;

    invoke-direct {v0}, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;-><init>()V

    sput-object v0, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;->INSTANCE:Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;
    ...
    sput-object v0, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;->a:Ljava/util/List;
...
.method public bridge synthetic a(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;->c(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lde/komoot/android/test/BookTripMutation$BookTrips;
...
.method public bridge synthetic b(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Ljava/lang/Object;)V
    ...
    check-cast p3, Lde/komoot/android/test/BookTripMutation$BookTrips;

    invoke-virtual {p0, p1, p2, p3}, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;->d(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lde/komoot/android/test/BookTripMutation$BookTrips;)V

    return-void
.end method

.method public c(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lde/komoot/android/test/BookTripMutation$BookTrips;
    .locals 7
    ...
    :goto_0
    sget-object v4, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$BookTrips;->a:Ljava/util/List;
    ...
    new-instance p1, Lde/komoot/android/test/BookTripMutation$BookTrips;
    ...
    invoke-direct {p1, p2, v2, v3}, Lde/komoot/android/test/BookTripMutation$BookTrips;-><init>(ZLjava/lang/String;Ljava/util/List;)V

    return-object p1

    :cond_0
    sget-object v3, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$Launch;->INSTANCE:Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$Launch;
...
.method public d(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lde/komoot/android/test/BookTripMutation$BookTrips;)V
    .locals 4
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/BookTripMutation$BookTrips;->c()Z
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/BookTripMutation$BookTrips;->b()Ljava/lang/String;
    ...
    sget-object v0, Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$Launch;->INSTANCE:Lde/komoot/android/test/adapter/BookTripMutation_ResponseAdapter$Launch;
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/BookTripMutation$BookTrips;->a()Ljava/util/List;
