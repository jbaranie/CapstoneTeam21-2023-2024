.class public final Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lde/komoot/android/test/CancelTripMutation$CancelTrip;",
        ">;"
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;",
        "Lcom/apollographql/apollo3/api/Adapter;",
        "Lde/komoot/android/test/CancelTripMutation$CancelTrip;",
...
# static fields
.field public static final INSTANCE:Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;

    invoke-direct {v0}, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;-><init>()V

    sput-object v0, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;->INSTANCE:Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;
    ...
    sput-object v0, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;->a:Ljava/util/List;
...
.method public bridge synthetic a(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;->c(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lde/komoot/android/test/CancelTripMutation$CancelTrip;
...
.method public bridge synthetic b(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Ljava/lang/Object;)V
    ...
    check-cast p3, Lde/komoot/android/test/CancelTripMutation$CancelTrip;

    invoke-virtual {p0, p1, p2, p3}, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;->d(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lde/komoot/android/test/CancelTripMutation$CancelTrip;)V

    return-void
.end method

.method public c(Lcom/apollographql/apollo3/api/json/JsonReader;Lcom/apollographql/apollo3/api/CustomScalarAdapters;)Lde/komoot/android/test/CancelTripMutation$CancelTrip;
    .locals 7
    ...
    :goto_0
    sget-object v4, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$CancelTrip;->a:Ljava/util/List;
    ...
    new-instance p1, Lde/komoot/android/test/CancelTripMutation$CancelTrip;
    ...
    invoke-direct {p1, p2, v2, v3}, Lde/komoot/android/test/CancelTripMutation$CancelTrip;-><init>(ZLjava/lang/String;Ljava/util/List;)V

    return-object p1

    :cond_0
    sget-object v3, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$Launch;->INSTANCE:Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$Launch;
...
.method public d(Lcom/apollographql/apollo3/api/json/JsonWriter;Lcom/apollographql/apollo3/api/CustomScalarAdapters;Lde/komoot/android/test/CancelTripMutation$CancelTrip;)V
    .locals 4
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/CancelTripMutation$CancelTrip;->c()Z
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/CancelTripMutation$CancelTrip;->b()Ljava/lang/String;
    ...
    sget-object v0, Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$Launch;->INSTANCE:Lde/komoot/android/test/adapter/CancelTripMutation_ResponseAdapter$Launch;
    ...
    invoke-virtual {p3}, Lde/komoot/android/test/CancelTripMutation$CancelTrip;->a()Ljava/util/List;
