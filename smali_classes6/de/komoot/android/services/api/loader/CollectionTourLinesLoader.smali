.class public final Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;
...
.method public constructor <init>(J)V
    ...
    invoke-direct/range {v0 .. v5}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;-><init>(JLde/komoot/android/data/ListPage;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public constructor <init>(JLde/komoot/android/data/ListPage;)V
    ...
    .line 4
    iput-wide p1, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->b:J
    ...
    iput-object p1, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->c:Ljava/util/LinkedHashMap;
    ...
    .line 6
    :cond_0
    invoke-direct {p0, p3}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->h(Lde/komoot/android/data/ListPage;)V
    ...
    .line 8
    :goto_0
    iput-object p1, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->d:Lde/komoot/android/data/IPager;
...
.method public synthetic constructor <init>(JLde/komoot/android/data/ListPage;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 9
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;-><init>(JLde/komoot/android/data/ListPage;)V
...
.method public constructor <init>(JLjava/util/LinkedHashMap;Lde/komoot/android/data/IPager;)V
    ...
    .line 12
    iput-object p3, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->c:Ljava/util/LinkedHashMap;

    .line 13
    iput-object p4, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->d:Lde/komoot/android/data/IPager;

    return-void
.end method

.method public static final synthetic f(Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;Lde/komoot/android/data/ListPage;)V
    .locals 0

    invoke-direct {p0, p1}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->h(Lde/komoot/android/data/ListPage;)V
...
.method private final h(Lde/komoot/android/data/ListPage;)V
    ...
    iget-object v1, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->c:Ljava/util/LinkedHashMap;
...
.method public bridge synthetic C(Lde/komoot/android/data/DataSource;Lde/komoot/android/data/loader/PaginatedMapLoader$LoadListener;)Lde/komoot/android/data/task/PaginatedListLoadTask;
    ...
    invoke-virtual {p0, p1, p2}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->m(Lde/komoot/android/services/api/source/CollectionAndGuideCompilationSource;Lde/komoot/android/data/loader/PaginatedMapLoader$LoadListener;)Lde/komoot/android/data/task/PaginatedListLoadTask;
...
.method public H0()I
    ...
    iget-object v0, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->c:Ljava/util/LinkedHashMap;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;
    ...
    :cond_1
    iget-wide v3, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->b:J

    check-cast p1, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;

    iget-wide v5, p1, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->b:J
...
.method public hasNextPage()Z
    ...
    iget-object v0, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->d:Lde/komoot/android/data/IPager;
...
.method public hasReachedEnd()Z
    ...
    invoke-virtual {p0}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->hasNextPage()Z
...
.method public hashCode()I
    ...
    iget-wide v0, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->b:J
...
.method public m(Lde/komoot/android/services/api/source/CollectionAndGuideCompilationSource;Lde/komoot/android/data/loader/PaginatedMapLoader$LoadListener;)Lde/komoot/android/data/task/PaginatedListLoadTask;
    ...
    iget-object v2, p0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;->d:Lde/komoot/android/data/IPager;

    invoke-interface {p1, v0, v1, v2}, Lde/komoot/android/services/api/source/CollectionAndGuideCompilationSource;->j(JLde/komoot/android/data/IPager;)Lde/komoot/android/data/task/PaginatedListLoadTask;
    ...
    new-instance v0, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader$loadNextPageAsync$1;

    invoke-direct {v0, p0, p2}, Lde/komoot/android/services/api/loader/CollectionTourLinesLoader$loadNextPageAsync$1;-><init>(Lde/komoot/android/services/api/loader/CollectionTourLinesLoader;Lde/komoot/android/data/loader/PaginatedMapLoader$LoadListener;)V
