.class final Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDBv2;->updateInformation(Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)Lde/komoot/android/services/api/UpdatedResult;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iput-object p2, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
...
.method public final invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/services/api/UpdatedResult;
    ...
    .line 3
    iget-object v2, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iget-object v3, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    .line 8
    invoke-virtual {v2}, Lde/komoot/android/data/room/UserHighlightEntity;->k()Ljava/lang/String;
    ...
    .line 9
    iget-object v1, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    .line 12
    invoke-static {v2, p1}, Lde/komoot/android/data/room/UserHighlightEntityExtensionKt;->e(Lde/komoot/android/data/room/UserHighlightEntity;Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/data/room/UserHighlightRatingEntity;
    ...
    .line 13
    invoke-virtual {v1}, Lde/komoot/android/data/room/UserHighlightRatingEntity;->e()Lde/komoot/android/services/api/model/HighlightVoteType;
    ...
    .line 14
    :cond_3
    invoke-static {v2, p1}, Lde/komoot/android/data/room/UserHighlightEntityExtensionKt;->d(Lde/komoot/android/data/room/UserHighlightEntity;Lde/komoot/android/data/room/TrackerDatabase;)Ljava/util/List;
    ...
    .line 17
    iget-object v6, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    invoke-virtual {v4}, Lde/komoot/android/data/room/UserHighlightImageEntity;->d()Ljava/lang/String;
    ...
    .line 20
    iget-object v4, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    check-cast v8, Lde/komoot/android/data/room/UserHighlightImageEntity;

    .line 25
    invoke-virtual {v8}, Lde/komoot/android/data/room/UserHighlightImageEntity;->k()Lde/komoot/android/recording/UploadAction;
    ...
    .line 27
    iget-object v6, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;
    ...
    invoke-static/range {v6 .. v11}, Lde/komoot/android/recording/TourTrackerDBv2;->transform$default(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/data/room/UserHighlightImageEntity;Lde/komoot/android/services/api/nativemodel/GenericTourPhoto;ILjava/lang/Object;)Lde/komoot/android/recording/TransformResult;

    move-result-object v4

    new-instance v6, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1$2;

    invoke-direct {v6, v3, v0}, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1$2;-><init>(Lde/komoot/android/data/MutableListSource;Lkotlin/jvm/internal/Ref$ObjectRef;)V
    ...
    .line 28
    new-instance v4, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1$3;

    iget-object v6, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    invoke-direct {v4, v6}, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1$3;-><init>(Lde/komoot/android/recording/TourTrackerDBv2;)V
    ...
    .line 29
    :cond_9
    invoke-static {v2, p1}, Lde/komoot/android/data/room/UserHighlightEntityExtensionKt;->f(Lde/komoot/android/data/room/UserHighlightEntity;Lde/komoot/android/data/room/TrackerDatabase;)Ljava/util/List;
    ...
    invoke-static {v2}, Lde/komoot/android/data/room/UserHighlightTipEntityExtensionKt;->a(Lde/komoot/android/data/room/UserHighlightTipEntity;)Lde/komoot/android/services/api/nativemodel/HighlightTipEntityReference;
    ...
    .line 35
    iget-object v2, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    .line 39
    iget-object v4, p0, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    invoke-virtual {v4}, Lde/komoot/android/recording/TourTrackerDBv2;->getPrincipalProvider()Lde/komoot/android/services/PrincipalProvider;
    ...
    invoke-static {v4, v2, v5, v6}, Lde/komoot/android/recording/TourTrackerDBv2;->access$transform(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/UserHighlightTipEntity;Lde/komoot/android/services/api/nativemodel/GenericUser;Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;)Lde/komoot/android/services/api/nativemodel/UserHighlightTip;
    ...
    check-cast v1, Lde/komoot/android/data/room/UserHighlightTipEntity;
    ...
    invoke-static {v4, v1, v5, v6}, Lde/komoot/android/recording/TourTrackerDBv2;->access$transform(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/UserHighlightTipEntity;Lde/komoot/android/services/api/nativemodel/GenericUser;Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;)Lde/komoot/android/services/api/nativemodel/UserHighlightTip;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDBv2$updateInformation$1;->invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/services/api/UpdatedResult;
