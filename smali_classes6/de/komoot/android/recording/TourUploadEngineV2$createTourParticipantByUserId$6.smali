.class final Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;
...
# direct methods
.method constructor <init>(Lde/komoot/android/data/room/TourParticipantEntity;Lde/komoot/android/recording/TourUploadEngineV2;Lde/komoot/android/data/room/TrackerDatabase;I)V
    .locals 0

    iput-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$participantEntity:Lde/komoot/android/data/room/TourParticipantEntity;

    iput-object p2, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;

    iput-object p3, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$database:Lde/komoot/android/data/room/TrackerDatabase;

    iput p4, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$versionToDo:I
...
.method public final invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
    ...
    .line 2
    iget-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$participantEntity:Lde/komoot/android/data/room/TourParticipantEntity;

    invoke-virtual {p1}, Lde/komoot/android/data/room/TourParticipantEntity;->e()Ljava/lang/String;
    ...
    const-string p1, "Solved: handle like success"

    .line 3
    invoke-static {v0, p1}, Lde/komoot/android/log/LogWrapper;->i0(Ljava/lang/String;Ljava/lang/String;)V

    .line 4
    iget-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;
    ...
    .line 5
    iget-object v1, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$database:Lde/komoot/android/data/room/TrackerDatabase;

    .line 6
    iget-object v2, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$participantEntity:Lde/komoot/android/data/room/TourParticipantEntity;
    ...
    .line 10
    iget p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->$versionToDo:I
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourUploadEngineV2$createTourParticipantByUserId$6;->invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
