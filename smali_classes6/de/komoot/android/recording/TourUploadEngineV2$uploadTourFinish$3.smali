.class final Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;
...
# direct methods
.method constructor <init>(Lde/komoot/android/services/api/nativemodel/TourID;Lde/komoot/android/recording/TourUploadEngineV2;Lkotlin/jvm/internal/Ref$ObjectRef;Lde/komoot/android/data/room/TrackerDatabase;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$serverId:Lde/komoot/android/services/api/nativemodel/TourID;

    iput-object p2, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;

    iput-object p3, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;

    iput-object p4, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$database:Lde/komoot/android/data/room/TrackerDatabase;
...
.method public final invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
    ...
    .line 2
    iget-object v1, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$serverId:Lde/komoot/android/services/api/nativemodel/TourID;
    ...
    .line 5
    iget-object v0, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;
    ...
    new-instance v1, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3$1;

    iget-object v2, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v3, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->$database:Lde/komoot/android/data/room/TrackerDatabase;

    invoke-direct {v1, v2, v3}, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3$1;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lde/komoot/android/data/room/TrackerDatabase;)V
    ...
    .line 7
    iget-object v1, p0, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourUploadEngineV2$uploadTourFinish$3;->invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
