.class final Lde/komoot/android/recording/TourTrackerDBv2$loadTourUploadList$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDBv2;->loadTourUploadList()Ljava/util/List;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDBv2;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDBv2$loadTourUploadList$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDBv2$loadTourUploadList$1;->invoke(Lde/komoot/android/data/room/TrackerDatabase;)Ljava/util/List;
...
.method public final invoke(Lde/komoot/android/data/room/TrackerDatabase;)Ljava/util/List;
    .locals 6
    ...
    .line 7
    iget-object v4, p0, Lde/komoot/android/recording/TourTrackerDBv2$loadTourUploadList$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    invoke-static {v4, p1, v3}, Lde/komoot/android/recording/TourTrackerDBv2;->access$deleteIfObsoleteAsync(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/services/touring/tracking/TourRecordingHandle;)V
    ...
    invoke-virtual {v2}, Lde/komoot/android/data/room/TourEntity;->q()Z

    move-result v4

    if-eqz v4, :cond_2

    const-string v4, "detect past Tour FINISH & COMPLETED"

    .line 10
    invoke-virtual {v2}, Lde/komoot/android/data/room/TourEntity;->t()Ljava/lang/String;
    ...
    .line 18
    :cond_5
    new-instance v1, Lde/komoot/android/recording/TourTrackerDBv2$TourComparator;

    invoke-direct {v1}, Lde/komoot/android/recording/TourTrackerDBv2$TourComparator;-><init>()V

    invoke-static {v0, v1}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 19
    iget-object v1, p0, Lde/komoot/android/recording/TourTrackerDBv2$loadTourUploadList$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;
    ...
    .line 23
    new-instance v4, Lde/komoot/android/recording/TrackedTour;
    ...
    invoke-direct {v4, v5, v3, p1}, Lde/komoot/android/recording/TrackedTour;-><init>(Lde/komoot/android/services/api/nativemodel/ParcelableGenericUser;Lde/komoot/android/data/room/TourEntity;Lde/komoot/android/data/room/TrackerDatabase;)V
