.class final Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDB;->isTourGeometryUploaded(Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;)Lde/komoot/android/recording/LoadResult;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDB;Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;->this$0:Lde/komoot/android/recording/TourTrackerDB;

    iput-object p2, p0, Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
...
.method public final invoke(Lde/komoot/android/db/DaoSession;)Lde/komoot/android/recording/LoadResult;
    ...
    .line 2
    iget-object v0, p0, Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;->this$0:Lde/komoot/android/recording/TourTrackerDB;

    iget-object v1, p0, Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    invoke-virtual {p1}, Lde/komoot/android/db/TourRecord;->s()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p1}, Lde/komoot/android/db/TourRecord;->t()Z
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDB$isTourGeometryUploaded$1;->invoke(Lde/komoot/android/db/DaoSession;)Lde/komoot/android/recording/LoadResult;
