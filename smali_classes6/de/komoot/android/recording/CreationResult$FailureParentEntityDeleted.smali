.class public final Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;
...
.method public constructor <init>(Lde/komoot/android/data/KmtEntityType;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    return-void
.end method

.method public static synthetic copy$default(Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;Lde/komoot/android/data/KmtEntityType;ILjava/lang/Object;)Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;
    .locals 0
    ...
    iget-object p1, p0, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    :cond_0
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;
...
.method public final component1()Lde/komoot/android/data/KmtEntityType;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    return-object v0
.end method

.method public final copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;
    .locals 1
    .param p1    # Lde/komoot/android/data/KmtEntityType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p1}, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;-><init>(Lde/komoot/android/data/KmtEntityType;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;
    ...
    :cond_1
    check-cast p1, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;

    iget-object v1, p0, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    iget-object p1, p1, Lde/komoot/android/recording/CreationResult$FailureParentEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;
