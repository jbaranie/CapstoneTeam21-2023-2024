.class public final Lde/komoot/android/recording/LoadRecommendedHighlightsTask;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/komoot/android/recording/LoadRecommendedHighlightsTask$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/komoot/android/recording/LoadRecommendedHighlightsTask;",
        "Lde/komoot/android/io/BaseStorageIOTask;",
        "",
        "Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;",
        "context",
        ...
        "original",
        "(Lde/komoot/android/recording/LoadRecommendedHighlightsTask;)V",
        "mTracker",
        "monitorPriority",
...
.field public static final Companion:Lde/komoot/android/recording/LoadRecommendedHighlightsTask$Companion;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private static final cLOG_TAG:Ljava/lang/String; = "LoadRecommendedHighlightsTask"
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lde/komoot/android/recording/LoadRecommendedHighlightsTask$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->Companion:Lde/komoot/android/recording/LoadRecommendedHighlightsTask$Companion;

    const/16 v0, 0x8

    sput v0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->$stable:I
...
.method public constructor <init>(Landroid/content/Context;Lde/komoot/android/recording/ITourTrackerDB;)V
    ...
    const-string v0, "LoadRecommendedHighlightsTask"

    .line 1
    invoke-direct {p0, p1, v0}, Lde/komoot/android/io/BaseStorageIOTask;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 2
    iput-object p2, p0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->mTracker:Lde/komoot/android/recording/ITourTrackerDB;

    return-void
.end method

.method protected constructor <init>(Lde/komoot/android/recording/LoadRecommendedHighlightsTask;)V
    .locals 1
    .param p1    # Lde/komoot/android/recording/LoadRecommendedHighlightsTask;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .line 4
    iget-object p1, p1, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->mTracker:Lde/komoot/android/recording/ITourTrackerDB;

    iput-object p1, p0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->mTracker:Lde/komoot/android/recording/ITourTrackerDB;
...
.method public bridge synthetic deepCopy()Lde/komoot/android/io/BaseStorageIOTask;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->deepCopy()Lde/komoot/android/recording/LoadRecommendedHighlightsTask;
...
.method public deepCopy()Lde/komoot/android/recording/LoadRecommendedHighlightsTask;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-direct {v0, p0}, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;-><init>(Lde/komoot/android/recording/LoadRecommendedHighlightsTask;)V
...
.method public bridge synthetic execute(Landroid/content/Context;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->execute(Landroid/content/Context;)Ljava/util/List;
...
.method protected execute(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 2
    invoke-virtual {p0}, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->throwIfCanceled()V

    .line 3
    iget-object p1, p0, Lde/komoot/android/recording/LoadRecommendedHighlightsTask;->mTracker:Lde/komoot/android/recording/ITourTrackerDB;

    invoke-interface {p1}, Lde/komoot/android/recording/ITourTrackerDB;->loadRecommendedHighlights()Ljava/util/List;
