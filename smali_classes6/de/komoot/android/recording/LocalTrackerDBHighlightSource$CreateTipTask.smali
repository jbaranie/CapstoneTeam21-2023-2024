.class final Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroid/content/Context;Lde/komoot/android/recording/ITourTrackerDB;Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;Lde/komoot/android/recording/IUploadManager;)V",
        "changeType",
...
.field private final creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lde/komoot/android/recording/ITourTrackerDB;Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;Lde/komoot/android/recording/IUploadManager;)V
    .locals 2
    ...
    .param p2    # Lde/komoot/android/recording/ITourTrackerDB;
        ...
        .end annotation
    .end param
    .param p3    # Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->context:Landroid/content/Context;

    iput-object p2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    iput-object p3, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;

    iput-object p4, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->uploadManager:Lde/komoot/android/recording/IUploadManager;
...
.method public bridge synthetic deepCopy()Lde/komoot/android/data/BaseListItemChangeTask;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->deepCopy()Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;
...
.method public deepCopy()Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;
    .locals 5
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    iget-object v1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->context:Landroid/content/Context;

    iget-object v2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    iget-object v3, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;

    iget-object v4, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->uploadManager:Lde/komoot/android/recording/IUploadManager;

    invoke-direct {v0, v1, v2, v3, v4}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;-><init>(Landroid/content/Context;Lde/komoot/android/recording/ITourTrackerDB;Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;Lde/komoot/android/recording/IUploadManager;)V
...
.method protected executeOpertaionOnThread()Lde/komoot/android/services/api/nativemodel/GenericUserHighlightTip;
    ...
    .line 2
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->throwIfCanceled()V

    .line 3
    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    iget-object v1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;

    invoke-virtual {v1}, Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;->c()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;

    invoke-virtual {v2}, Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;->d()Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;

    move-result-object v2

    iget-object v3, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->creation:Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;

    invoke-virtual {v3}, Lde/komoot/android/services/api/nativemodel/UserHighlightTipCreation;->b()Lde/komoot/android/services/api/nativemodel/HighlightAnalyticsSourceTool;

    move-result-object v3

    invoke-interface {v0, v1, v2, v3}, Lde/komoot/android/recording/ITourTrackerDB;->addUserHighlightTip(Ljava/lang/String;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;Lde/komoot/android/services/api/nativemodel/HighlightAnalyticsSourceTool;)Lde/komoot/android/recording/CreationResult;

    move-result-object v0

    .line 4
    sget-object v1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask$executeOpertaionOnThread$1;->INSTANCE:Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask$executeOpertaionOnThread$1;
    ...
    .line 7
    iget-object v1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->uploadManager:Lde/komoot/android/recording/IUploadManager;
...
.method public bridge synthetic executeOpertaionOnThread()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$CreateTipTask;->executeOpertaionOnThread()Lde/komoot/android/services/api/nativemodel/GenericUserHighlightTip;
