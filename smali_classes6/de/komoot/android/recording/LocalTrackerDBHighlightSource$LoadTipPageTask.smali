.class final Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "pOriginal",
        "(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;)V",
        "highlightReference",
        "monitorPriority",
...
.method public constructor <init>(Lde/komoot/android/recording/ITourTrackerDB;Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;Lde/komoot/android/services/api/IndexPager;)V
    ...
    .line 2
    iput v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->taskTimeout:I

    .line 3
    sget-object v0, Lde/komoot/android/log/MonitorPriority;->MEDIUM:Lde/komoot/android/log/MonitorPriority;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->monitorPriority:Lde/komoot/android/log/MonitorPriority;

    .line 4
    iput-object p2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    .line 5
    iput-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->tourTrackerDB:Lde/komoot/android/recording/ITourTrackerDB;
    ...
    :cond_0
    iput-object p3, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;

    return-void
.end method

.method public constructor <init>(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;)V
    .locals 1
    .param p1    # Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .line 10
    iget-object v0, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    .line 11
    iget-object v0, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->tourTrackerDB:Lde/komoot/android/recording/ITourTrackerDB;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->tourTrackerDB:Lde/komoot/android/recording/ITourTrackerDB;

    .line 12
    iget-object p1, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;

    iput-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;
...
.method public bridge synthetic deepCopy()Lde/komoot/android/data/task/BasePaginatedListLoadTask;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->deepCopy()Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;
...
.method public deepCopy()Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-direct {v0, p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;-><init>(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;)V
...
.method protected executeOpertaionOnThread(Lde/komoot/android/data/task/RequestStrategy;)Lde/komoot/android/data/ListPage;
    ...
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->throwIfCanceled()V

    iget-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;
    ...
    iget-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->tourTrackerDB:Lde/komoot/android/recording/ITourTrackerDB;

    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    iget-object v1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;

    invoke-interface {p1, v0, v1}, Lde/komoot/android/recording/ITourTrackerDB;->loadUserHighlightTips(Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;Lde/komoot/android/services/api/IndexPager;)Lde/komoot/android/recording/LoadResult;
...
.method public getMonitorPriority()Lde/komoot/android/log/MonitorPriority;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->monitorPriority:Lde/komoot/android/log/MonitorPriority;
...
.method public getTaskTimeout()I
    ...
    iget v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->taskTimeout:I
...
.method public logEntity(ILjava/lang/String;)V
    ...
    .line 2
    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadTipPageTask;->pager:Lde/komoot/android/services/api/IndexPager;
