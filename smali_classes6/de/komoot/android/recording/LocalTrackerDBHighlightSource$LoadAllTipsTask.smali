.class final Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "pOriginal",
        "(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;)V",
        "highlightReference",
        "monitorPriority",
...
.method public constructor <init>(Lde/komoot/android/recording/ITourTrackerDB;Lde/komoot/android/util/concurrent/WatchDogThreadPoolExecutor;Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;)V
    ...
    .line 2
    iput p2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->taskTimeout:I

    .line 3
    sget-object p2, Lde/komoot/android/log/MonitorPriority;->MEDIUM:Lde/komoot/android/log/MonitorPriority;

    iput-object p2, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->monitorPriority:Lde/komoot/android/log/MonitorPriority;

    .line 4
    iput-object p3, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    .line 5
    iput-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;
    ...
    iput-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->pager:Lde/komoot/android/services/api/IndexPager;

    return-void
.end method

.method public constructor <init>(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;)V
    .locals 1
    .param p1    # Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .line 8
    iput v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->taskTimeout:I

    .line 9
    sget-object v0, Lde/komoot/android/log/MonitorPriority;->MEDIUM:Lde/komoot/android/log/MonitorPriority;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->monitorPriority:Lde/komoot/android/log/MonitorPriority;

    .line 10
    iget-object v0, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;

    .line 11
    iget-object v0, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    iput-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    .line 12
    iget-object p1, p1, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->pager:Lde/komoot/android/services/api/IndexPager;
...
.method public deepCopy()Lde/komoot/android/data/task/BasePaginatedListLoadTask;
    ...
    invoke-direct {v0, p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;-><init>(Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;)V
...
.method public bridge synthetic deepCopy()Lde/komoot/android/data/task/ManagedPaginatedListLoadTask;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->deepCopy()Lde/komoot/android/data/task/BasePaginatedListLoadTask;
...
.method protected executeOpertaionOnThread(Lde/komoot/android/data/task/RequestStrategy;)Lde/komoot/android/data/ListPage;
    ...
    invoke-virtual {p0}, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->throwIfCanceled()V

    iget-object p1, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->tracker:Lde/komoot/android/recording/ITourTrackerDB;

    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->highlightReference:Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->pager:Lde/komoot/android/services/api/IndexPager;
...
.method public getMonitorPriority()Lde/komoot/android/log/MonitorPriority;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->monitorPriority:Lde/komoot/android/log/MonitorPriority;
...
.method public getTaskTimeout()I
    ...
    iget v0, p0, Lde/komoot/android/recording/LocalTrackerDBHighlightSource$LoadAllTipsTask;->taskTimeout:I
