.class final Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;
...
.method constructor <init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/services/api/model/TourV7;Lde/komoot/android/recording/TourUploadEngineV2;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;

    iput-object p2, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$database:Lde/komoot/android/data/room/TrackerDatabase;

    iput-object p3, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$serverTour:Lde/komoot/android/services/api/model/TourV7;

    iput-object p4, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->invoke()V
...
.method public final invoke()V
    ...
    .line 2
    iget-object v1, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 3
    iget-object v4, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$database:Lde/komoot/android/data/room/TrackerDatabase;
    ...
    .line 4
    iget-object v2, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$serverTour:Lde/komoot/android/services/api/model/TourV7;

    invoke-virtual {v2}, Lde/komoot/android/services/api/model/TourV7;->q()Lde/komoot/android/services/api/model/Sport;
    ...
    .line 5
    iget-object v2, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;

    iget-object v5, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    invoke-virtual {v5}, Lde/komoot/android/data/room/TourEntity;->y()Ljava/util/Date;

    move-result-object v5

    iget-object v6, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$serverTour:Lde/komoot/android/services/api/model/TourV7;
    ...
    .line 6
    iget-object v2, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$3;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    const-string v2, "update server.tour.sport -> local.tour.sport"
