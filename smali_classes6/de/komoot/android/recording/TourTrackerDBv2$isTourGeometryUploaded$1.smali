.class final Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDBv2;->isTourGeometryUploaded(Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;)Lde/komoot/android/recording/LoadResult;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iput-object p2, p0, Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
...
.method public final invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/LoadResult;
    ...
    .line 2
    iget-object v0, p0, Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iget-object v1, p0, Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    invoke-virtual {p1}, Lde/komoot/android/data/room/TourEntity;->q()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p1}, Lde/komoot/android/data/room/TourEntity;->l()Z
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDBv2$isTourGeometryUploaded$1;->invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/LoadResult;
