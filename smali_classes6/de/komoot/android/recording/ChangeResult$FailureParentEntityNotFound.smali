.class public final Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;
...
.method public constructor <init>(Lde/komoot/android/data/KmtEntityType;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->entity:Lde/komoot/android/data/KmtEntityType;

    return-void
.end method

.method public static synthetic copy$default(Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;Lde/komoot/android/data/KmtEntityType;ILjava/lang/Object;)Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;
    .locals 0
    ...
    iget-object p1, p0, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->entity:Lde/komoot/android/data/KmtEntityType;

    :cond_0
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;
...
.method public final component1()Lde/komoot/android/data/KmtEntityType;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->entity:Lde/komoot/android/data/KmtEntityType;

    return-object v0
.end method

.method public final copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;
    .locals 1
    .param p1    # Lde/komoot/android/data/KmtEntityType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    new-instance v0, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;

    invoke-direct {v0, p1}, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;-><init>(Lde/komoot/android/data/KmtEntityType;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;
    ...
    :cond_1
    check-cast p1, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;

    iget-object v1, p0, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->entity:Lde/komoot/android/data/KmtEntityType;

    iget-object p1, p1, Lde/komoot/android/recording/ChangeResult$FailureParentEntityNotFound;->entity:Lde/komoot/android/data/KmtEntityType;
