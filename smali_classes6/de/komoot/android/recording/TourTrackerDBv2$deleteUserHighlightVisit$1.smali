.class final Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDBv2;->deleteUserHighlightVisit(Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)Lde/komoot/android/recording/ChangeResult;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iput-object p2, p0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;

    iput-object p3, p0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
...
.method public final invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/ChangeResult;
    ...
    .line 2
    iget-object v1, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iget-object v2, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    .line 5
    iget-object v1, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    iget-object v3, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    iget-object v2, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;
    ...
    invoke-static {v1, v15, v14, v2}, Lde/komoot/android/recording/TourTrackerDBv2;->access$findUserHighlightVisitRecord(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/data/room/TourEntity;Lde/komoot/android/services/api/nativemodel/HighlightEntityReference;)Lde/komoot/android/data/room/UserHighlightVisitEntity;

    move-result-object v1

    const-string v13, "delete user highlight visit"
    ...
    .line 9
    iget-object v2, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;
    ...
    .line 12
    invoke-virtual {v1}, Lde/komoot/android/data/room/UserHighlightVisitEntity;->h()I
    ...
    .line 13
    invoke-static/range {v1 .. v13}, Lde/komoot/android/data/room/UserHighlightVisitEntityExtensionKt;->g(Lde/komoot/android/data/room/UserHighlightVisitEntity;Lde/komoot/android/data/room/TrackerDatabase;JJLjava/util/Date;Lde/komoot/android/recording/UploadState;Lde/komoot/android/recording/UploadAction;IIILjava/lang/Object;)Lde/komoot/android/data/room/UserHighlightVisitEntity;
    ...
    invoke-interface {v1, v2, v15}, Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;->removeUserHighlight(Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;Z)V
    ...
    iget-object v3, v0, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->$userHighlight:Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;

    invoke-static {v1, v2, v3}, Lde/komoot/android/recording/TourTrackerDBv2;->access$findOrCreatePassiveHighlightRecord(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/services/api/nativemodel/GenericUserHighlight;)Lde/komoot/android/recording/LoadResult;
    ...
    .line 22
    invoke-virtual/range {v41 .. v41}, Lde/komoot/android/data/room/TourEntity;->m()J
    ...
    .line 24
    sget-object v10, Lde/komoot/android/recording/UploadAction;->DELETE:Lde/komoot/android/recording/UploadAction;

    .line 25
    sget-object v9, Lde/komoot/android/recording/UploadState;->QUEUED:Lde/komoot/android/recording/UploadState;

    .line 26
    new-instance v1, Lde/komoot/android/data/room/UserHighlightVisitEntity;
    ...
    invoke-direct/range {v3 .. v12}, Lde/komoot/android/data/room/UserHighlightVisitEntity;-><init>(JJLjava/util/Date;Lde/komoot/android/recording/UploadState;Lde/komoot/android/recording/UploadAction;II)V

    .line 27
    invoke-virtual/range {p1 .. p1}, Lde/komoot/android/data/room/TrackerDatabase;->T()Lde/komoot/android/data/room/UserHighlightVisitEntityDao;

    move-result-object v3

    invoke-interface {v3, v1}, Lde/komoot/android/data/room/UserHighlightVisitEntityDao;->d(Lde/komoot/android/data/room/UserHighlightVisitEntity;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDBv2$deleteUserHighlightVisit$1;->invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/ChangeResult;
