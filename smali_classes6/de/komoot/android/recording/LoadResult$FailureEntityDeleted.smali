.class public final Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;
...
.method public constructor <init>(Lde/komoot/android/data/KmtEntityType;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    return-void
.end method

.method public static synthetic copy$default(Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;Lde/komoot/android/data/KmtEntityType;ILjava/lang/Object;)Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;
    .locals 0
    ...
    iget-object p1, p0, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    :cond_0
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;
...
.method public final component1()Lde/komoot/android/data/KmtEntityType;
    ...
    iget-object v0, p0, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    return-object v0
.end method

.method public final copy(Lde/komoot/android/data/KmtEntityType;)Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;
    .locals 1
    .param p1    # Lde/komoot/android/data/KmtEntityType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    new-instance v0, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;

    invoke-direct {v0, p1}, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;-><init>(Lde/komoot/android/data/KmtEntityType;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    check-cast p1, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;

    iget-object v1, p0, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;

    iget-object p1, p1, Lde/komoot/android/recording/LoadResult$FailureEntityDeleted;->entity:Lde/komoot/android/data/KmtEntityType;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "FailureEntityDeleted(entity="
