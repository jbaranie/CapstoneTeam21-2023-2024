.class final Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;
...
.field final synthetic $remoteVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;
...
# direct methods
.method constructor <init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/services/api/nativemodel/TourVisibility;Lde/komoot/android/recording/TourUploadEngineV2;Lde/komoot/android/services/api/model/TourV7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;

    iput-object p2, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$database:Lde/komoot/android/data/room/TrackerDatabase;

    iput-object p3, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$remoteVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;

    iput-object p4, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;

    iput-object p5, p0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$serverTour:Lde/komoot/android/services/api/model/TourV7;
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->invoke()V
...
.method public final invoke()V
    ...
    .line 2
    iget-object v1, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 3
    iget-object v4, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$database:Lde/komoot/android/data/room/TrackerDatabase;
    ...
    .line 4
    iget-object v13, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$remoteVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;

    .line 5
    iget-object v14, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->this$0:Lde/komoot/android/recording/TourUploadEngineV2;
    ...
    iget-object v15, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$serverTour:Lde/komoot/android/services/api/model/TourV7;
    ...
    .line 6
    iget-object v2, v0, Lde/komoot/android/recording/TourUploadEngineV2$downSyncTourFromServer$4;->$tour:Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    const-string v2, "update server.tour.visibility -> local.tour.visibility"
