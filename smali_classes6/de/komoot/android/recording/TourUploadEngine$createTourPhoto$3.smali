.class final Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourUploadEngine;->createTourPhoto(Lde/komoot/android/db/PoiRecord;Lde/komoot/android/recording/UploadInterruptMonitor;Lde/komoot/android/services/api/KmtDateFormatV6;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method constructor <init>(Lde/komoot/android/recording/TourUploadEngine;Lde/komoot/android/db/PoiRecord;)V
    ...
    iput-object p1, p0, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->this$0:Lde/komoot/android/recording/TourUploadEngine;

    iput-object p2, p0, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->$photoRecord:Lde/komoot/android/db/PoiRecord;
...
.method public final invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
    ...
    const-string v0, "failed to create tour.photo / tour was missing -> delete it"
    ...
    .line 4
    iget-object v0, p0, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->this$0:Lde/komoot/android/recording/TourUploadEngine;
    ...
    .line 5
    iget-object v2, p0, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->$photoRecord:Lde/komoot/android/db/PoiRecord;
    ...
    .line 9
    iget-object v0, p0, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->$photoRecord:Lde/komoot/android/db/PoiRecord;
    ...
    .line 10
    invoke-virtual/range {v1 .. v6}, Lde/komoot/android/recording/TourTrackerDB;->writeLocked$data_touring_release(Lde/komoot/android/db/PoiRecord;Lde/komoot/android/recording/UploadState;Lde/komoot/android/recording/UploadAction;Ljava/lang/Integer;Ljava/lang/Integer;)V

    const-string v0, "FAILURE_UPLOADER_TOUR_IMAGE_HTTP_404"
    ...
    const-string v2, "UPLOAD_CREATE_TOUR_PHOTO_HTTP_404"
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourUploadEngine$createTourPhoto$3;->invoke(Lde/komoot/android/net/exception/HttpFailureException;)Lde/komoot/android/recording/EntityOp;
