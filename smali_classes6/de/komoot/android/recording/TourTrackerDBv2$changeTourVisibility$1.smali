.class final Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lde/komoot/android/recording/TourTrackerDBv2;->changeTourVisibility(Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;Lde/komoot/android/services/api/nativemodel/TourVisibility;)Lde/komoot/android/recording/ChangeResult;
.end annotation
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1$WhenMappings;
    }
.end annotation
...
# direct methods
.method constructor <init>(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;Lde/komoot/android/services/api/nativemodel/TourVisibility;)V
    .locals 0

    iput-object p1, p0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iput-object p2, p0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;

    iput-object p3, p0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$newVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;
...
.method public final invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/ChangeResult;
    ...
    .line 2
    iget-object v1, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iget-object v2, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;

    invoke-static {v1, v13, v2}, Lde/komoot/android/recording/TourTrackerDBv2;->access$findTourRecord(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;)Lde/komoot/android/data/room/TourEntity;
    ...
    .line 5
    iget-object v1, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    iget-object v3, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;
    ...
    .line 30
    iget-object v2, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;
    ...
    iget-object v3, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$newVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;
    ...
    .line 36
    iget-object v3, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->this$0:Lde/komoot/android/recording/TourTrackerDBv2;

    iget-object v4, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$newVisibility:Lde/komoot/android/services/api/nativemodel/TourVisibility;

    move-object/from16 v5, p1

    invoke-static {v3, v5, v1, v4}, Lde/komoot/android/recording/TourTrackerDBv2;->access$changeTourVisibilityInternal(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/data/room/TrackerDatabase;Lde/komoot/android/data/room/TourEntity;Lde/komoot/android/services/api/nativemodel/TourVisibility;)Lde/komoot/android/recording/ChangeResult;

    move-result-object v3

    .line 37
    invoke-interface {v3}, Lde/komoot/android/recording/ChangeResult;->isSuccess()Z
    ...
    sget-object v4, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    sget-object v5, Lde/komoot/android/services/api/nativemodel/TourVisibility;->FUTURE_FRIENDS:Lde/komoot/android/services/api/nativemodel/TourVisibility;

    invoke-interface {v3, v5, v4}, Lde/komoot/android/services/api/nativemodel/GenericTour;->changeVisibility(Lde/komoot/android/services/api/nativemodel/TourVisibility;Z)V
    ...
    sget-object v5, Lde/komoot/android/services/api/nativemodel/TourVisibility;->FUTURE_PUBLIC:Lde/komoot/android/services/api/nativemodel/TourVisibility;
    ...
    sget-object v5, Lde/komoot/android/services/api/nativemodel/TourVisibility;->CHANGING_TO_FRIENDS:Lde/komoot/android/services/api/nativemodel/TourVisibility;
    ...
    iget-object v5, v0, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->$recordedTour:Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;

    invoke-interface {v5}, Lde/komoot/android/services/api/nativemodel/InterfaceRecordedTour;->getEntityReference()Lde/komoot/android/services/api/nativemodel/TourEntityReference;

    move-result-object v5

    invoke-static {v3, v5, v1}, Lde/komoot/android/recording/TourTrackerDBv2;->access$updateEntityRefIfNeeded(Lde/komoot/android/recording/TourTrackerDBv2;Lde/komoot/android/services/api/nativemodel/TourEntityReference;Lde/komoot/android/data/room/TourEntity;)V
    ...
    const-string v5, "change tour.visibility "
    ...
    invoke-direct {v1, v4}, Lde/komoot/android/recording/ChangeResult$Success;-><init>(Z)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lde/komoot/android/recording/TourTrackerDBv2$changeTourVisibility$1;->invoke(Lde/komoot/android/data/room/TrackerDatabase;)Lde/komoot/android/recording/ChangeResult;
